...
tabla %>%  
 gt() %>% 
   tab_header(title = "Matriz de migración laboral, 2015", 
...
#svglite::svglite(paste0(here::here(), "/Graficos/Estado/03_Movilidad laboral/2015/ChordDiagram de MTrab a nivel estatal.svg"), width = 20, height = 20)
circos.clear()
cairo_pdf(paste0(here::here(), "/Graficos/Estado/03_Movilidad laboral/2015/ChordDiagram de MTrab a nivel estatal.pdf"),
          width = 7, height = 7, 
...
cairo_pdf(paste0(here::here(),"/Graficos/Estado/03_Movilidad laboral/2015/ChordDiagram de MTrab para cada estado.pdf"),
          width = 8,
          height = 8, 
          family = "Montserrat Medium",
          fallback_resolution = 400,
...
cairo_pdf(paste0(here::here(), "/Graficos/Estado/03_Movilidad laboral/2015/Etiquetas a nivel estatal.pdf"), 
          width = 7, height = 8, 
          fallback_resolution = 400,
...
```{r, echo = FALSE}
load(file = paste0(here::here(), "/Output/Estado/03_Movilidad laboral/2015/Indicadores de MTrab a nivel estatal 2015.RData"))
...
**Matriz de migración laboral hace 5 años a nivel municipal, 2015 - 2015**  
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/03_Movilidad laboral/2015/ChordDiagram de MTrab desagregado por municipio.pdf"),
          width = 15,
          height = 10, 
          family = "Montserrat Medium",
          fallback_resolution = 400,
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/03_Movilidad laboral/2015/Etiquetas a nivel municipal.pdf"), 
          width = 7, height = 10, 
          fallback_resolution = 400,
          family = "montserrat", onefile = TRUE)
for(i in 1:length(estados)){
...
```{r, echo = FALSE}
load(file = paste0(here::here(), "/Output/Municipio/03_Movilidad laboral/2015/Indicadores de movilidad laboral a nivel municipal 2015.RData"))
...
**Matriz de migración laboral hace 5 años a nivel municipal, 2015**  
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/03_Movilidad laboral/2015/ChordDiagram de Mtrab desagregado a nivel intramunicipal.pdf"),
          width = 15,
          height = 10, 
          family = "Montserrat Medium",
          fallback_resolution = 400,
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/03_Movilidad laboral/2015/Etiquetas a nivel intramunicipal.pdf"), 
          width = 7, height = 8, 
          fallback_resolution = 400,
          family = "montserrat", onefile = TRUE)
for(i in 1:length(estados)){
...
```{r, echo = FALSE}
load(file = paste0(here::here(), "/Output/Municipio/03_Movilidad laboral/2015/Indicadores de MTrab a nivel intramunicipal 2015.RData"))
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/03_Movilidad laboral/2015/ChordDiagram de Mtrab desagregado a nivel intermunicipal.pdf"),
          width = 15,
          height = 10, 
          family = "Montserrat Medium",
          fallback_resolution = 400,
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/03_Movilidad laboral/2015/Etiquetas a nivel intermunicipal.pdf"), 
          width = 7, height = 8, 
          fallback_resolution = 400,
          family = "montserrat", onefile = TRUE)
for(i in 1:length(estados)){
...
```{r, echo = FALSE}
load(file = paste0(here::here(), "/Output/Municipio/03_Movilidad laboral/2015/Indicadores de MTrab a nivel intermunicipal 2015.RData"))
