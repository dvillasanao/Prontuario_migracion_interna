...
#svglite::svglite(paste0(here::here(), "/Graficos/Estado/03_Movilidad laboral/2010/ChordDiagram de MTrab a nivel estatal.svg"), width = 20, height = 20)
circos.clear()
cairo_pdf(paste0(here::here(), "/Graficos/Estado/03_Movilidad laboral/2010/ChordDiagram de MTrab a nivel estatal.pdf"),
          width = 7, height = 7, 
                ...
                #Se agrupan los totales
                 full_join(
                           ...
                           rename("CVE_ENT" = "name",
                            ...
                            select(`Entran por trabajo`, CVE_ENT, `Salen por trabajo`)
  }
)
...
cairo_pdf(paste0(here::here(),"/Graficos/Estado/03_Movilidad laboral/2010/ChordDiagram de MTrab para cada estado.pdf"),
          width = 8,
          height = 8, 
          family = "Montserrat Medium",
          fallback_resolution = 400,
...
cairo_pdf(paste0(here::here(), "/Graficos/Estado/03_Movilidad laboral/2010/Etiquetas a nivel estatal.pdf"), 
          width = 7, height = 8, 
          fallback_resolution = 400,
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/03_Movilidad laboral/2010/ChordDiagram de MTrab desagregado por municipio.pdf"),
          width = 15,
          height = 10, 
          family = "Montserrat Medium",
          fallback_resolution = 400,
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/03_Movilidad laboral/2010/Etiquetas a nivel municipal.pdf"), 
          width = 7, height = 10, 
          fallback_resolution = 400,
          family = "montserrat", onefile = TRUE)
for(i in 1:length(estados)){
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/03_Movilidad laboral/2010/ChordDiagram de Mtrab desagregado a nivel intramunicipal.pdf"),
          width = 15,
          height = 10, 
          family = "Montserrat Medium",
          fallback_resolution = 400,
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/03_Movilidad laboral/2010/Etiquetas a nivel intramunicipal.pdf"), 
          width = 7, height = 8, 
          fallback_resolution = 400,
          family = "montserrat", onefile = TRUE)
for(i in 1:length(estados)){
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/03_Movilidad laboral/2010/ChordDiagram de Mtrab desagregado a nivel intermunicipal.pdf"),
          width = 15,
          height = 10, 
          family = "Montserrat Medium",
          fallback_resolution = 400,
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/03_Movilidad laboral/2010/Etiquetas a nivel intermunicipal.pdf"), 
          width = 7, height = 8, 
          fallback_resolution = 400,
          family = "montserrat", onefile = TRUE)
for(i in 1:length(estados)){
