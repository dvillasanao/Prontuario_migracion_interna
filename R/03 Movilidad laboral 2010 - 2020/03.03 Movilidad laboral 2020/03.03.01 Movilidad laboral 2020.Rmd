...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/03_Movilidad laboral/2020/Etiquetas a nivel intramunicipal.pdf"), 
          width = 7, height = 8, 
          fallback_resolution = 400,
          family = "montserrat", onefile = TRUE)
for(i in 1:length(estados)){
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/03_Movilidad laboral/2020/ChordDiagram de Mtrab desagregado a nivel intermunicipal.pdf"),
          width = 15,
          height = 10, 
          family = "Montserrat Medium",
          fallback_resolution = 400,
