...
write.table(p, file = paste0(here::here(), "/Bases/Estado/03_Movilidad laboral/2020/Filtro a nivel estatal.txt"))
...
path = paste0(here::here(), "/Graficos/Estado/03_Movilidad laboral/2020/Etiquetas a nivel estatal.pdf")
...
saveRDS(tabla2, file = paste0(here::here(), "/Output/Municipio/03_Movilidad laboral/2020/Paleta de colores MTrab a nivel municipal.RDS"))
```


```{r, eval = FALSE}
pdf(paste0(here::here(), "/Graficos/Municipio/03_Movilidad laboral/2020/ChordDiagram de MTrab desagregado por municipio.pdf"), width = 20, height = 20)
for(i in 1:32){
