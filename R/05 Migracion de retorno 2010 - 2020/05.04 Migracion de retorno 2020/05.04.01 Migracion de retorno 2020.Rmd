...
p %>% 
 mapshot(url = paste0(here::here(),"/images/MRt_2020.html"))
...
```{r}
file = "/Graficos/Estado/05_Migracion de retorno/2020/ChordDiagram de MRt a nivel estatal.pdf"
...
## Se guardan las matrices de migración de retorno para analizarlos después. 
wb <- createWorkbook()
for(i in 1:32){
     tabla <- tabla1[[i]] %>%
                as.data.frame() %>%
...
```{r tablas de matrices estatal, eval = FALSE}
...
```{r, eval = FALSE}
file = "/Graficos/Estado/05_Migracion de retorno/2020/ChordDiagram de MRt para cada estado.pdf"
...
```{r etiquetas_estatal}
file = "/Graficos/Estado/05_Migracion de retorno/2020/Etiquetas a nivel estatal.pdf"
