...
Migrantes <- svytable(~ENT + ENT_PAIS_RES_5A, design = MC)  
...
path = paste0(here::here(),"/Graficos/Estado/05_Migracion de retorno/2020/GSankey de MRt desagregado por estados_Absolutos.pdf")
