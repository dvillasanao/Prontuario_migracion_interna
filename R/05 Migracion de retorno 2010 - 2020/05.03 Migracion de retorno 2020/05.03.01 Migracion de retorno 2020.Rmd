...
circos.clear()
cairo_pdf(paste0(here::here(),"/Graficos/Estado/05_Migracion de retorno/2020/ChordDiagram de MRt a nivel estatal.pdf"), width = 20, height = 20)
...
save(tabla1, file = paste0(here::here(), "/Output/Estado/05_Migracion de retorno/2020/Tabla MRt a nivel estatal.RDS"))
```
...
```{r, eval = FALSE}
pdf(paste0(here::here(),"/Graficos/Estado/05_Migracion de retorno/2020/ChordDiagram de MRt para cada estado.pdf"), width = 20, height = 20)
for(i in 1:32){
# Paleta de colores 
...
path = paste0(here::here(), "/Graficos/Estado/05_Migracion de retorno/2020/Etiquetas a nivel estatal.pdf")
