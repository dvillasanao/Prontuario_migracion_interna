...
mydata <- mydata %>%
           select(CVE_ENT, NOM_ENT,ENT_PAIS_NAC, ENT_PAIS_RES10, EDAD,
...
save(Migrantes, file = paste0(here::here(), "/Bases/Estado/05_Migracion de retorno/2015/Matriz de MRt a nivel estatal 2015.RData"))
```
...
load(file = paste0(here::here(), "/Bases/Estado/05_Migracion de retorno/2015/Matriz de MRt a nivel estatal 2015.RData"))
...
p %>% 
 mapshot(url = paste0(here::here(),"/images/MRt_2015.html"))
...
```{r}
file = "/Graficos/Estado/05_Migracion de retorno/2015/ChordDiagram de MRt a nivel estatal.pdf"
...
#p <- data.frame(estados = est,
 #               filtro_estados = filtro_mig,
                 #NUM = 1:32)
#write.xlsx(p, file = paste0(here::here(), "/Bases/Estado/05_Migracion de retorno/2015/Filtro a nivel estatal.xlsx"))

filtro_mig <- read.xlsx(paste0(here::here(), "/Bases/Estado/05_Migracion de retorno/2015/Filtro a nivel estatal.xlsx"), colNames = TRUE) %>% 
               pull(filtro_estados)
...
for(i in 1:32){
     ...
     saveWorkbook(wb, 
                  file = paste0(here::here(), "/Output/Estado/05_Migracion de retorno/2015/Matriz MRt por estados_2015_Reduccion.xlsx"), 
               overwrite = TRUE)
}

saveRDS(tabla1, file = paste0(here::here(), "/Output/Estado/05_Migracion de retorno/2015/Tabla MRt a nivel estatal.RDS"))
```

```{r tablas de matrices}
tabla1 <- readRDS(file = paste0(here::here(), "/Output/Estado/05_Migracion de retorno/2015/Tabla MRt a nivel estatal.RDS"))
...
for(i in 1:32){
     ...
     saveWorkbook(wb, 
                  file = paste0(here::here(), "/Output/Estado/05_Migracion de retorno/2015/Matriz MRt por estados_2015_Reduccion_Totales.xlsx"), 
               overwrite = TRUE)
}
```
...
```{r, eval = FALSE}
file = "/Graficos/Estado/05_Migracion de retorno/2015/ChordDiagram de MRt para cada estado.pdf"
...
```{r etiquetas_estatal}
file = "/Graficos/Estado/05_Migracion de retorno/2015/Etiquetas a nivel estatal.pdf"
...
filtro_mig <- read.xlsx(paste0(here::here(), "/Bases/Estado/05_Migracion de retorno/2015/Filtro a nivel estatal_Retorno.xlsx"), colNames = TRUE) %>% 
               pull(filtro_estados)
...
for(i in 1:32){
     ...
     writeData(wb, i, tabla, colNames = TRUE, rowNames = TRUE)
     saveWorkbook(wb, 
                  file = paste0(here::here(), "/Output/Estado/05_Migracion de retorno/2015/Matriz MRt por estados_2015_GGSankey_Reduccion.xlsx"), 
               overwrite = TRUE)
}

saveRDS(tabla1, file = paste0(here::here(), "/Output/Estado/05_Migracion de retorno/2015/Tabla MRt a nivel estatal_GGSankey.RDS"))
```
