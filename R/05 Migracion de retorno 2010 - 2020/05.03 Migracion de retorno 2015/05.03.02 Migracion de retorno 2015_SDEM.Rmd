...
```{r, class.source = "fold-hide"}
Indicadores <- function(Variable, df.claves = CVE_ENT, grupo = estados,  Origen = "CVE_ENT", Destino = "ENT_PAIS_RES_5A", filtro = "EDAD >= 5 & EDAD <= 130"){
...
#tabla1 <- Indicadores("SEXO", df.claves = CVE_ENT, grupo = estados,  Origen = "CVE_ENT", Destino = "ENT_PAIS_RES_5A", filtro = "EDAD >= 5 & EDAD <= 130")
```

## Valores relativos

```{r, class.source = "fold-hide"}
Indicadores_P <- function(Variable, df.claves = CVE_ENT, grupo = estados,  Origen = "CVE_ENT", Destino = "ENT_PAIS_RES_5A", filtro = "EDAD >= 5 & EDAD <= 130"){
