...
circos.clear()
cairo_pdf(paste0(here::here(),"/Graficos/Estado/05_Migracion de retorno/2010/ChordDiagram de MRt a nivel estatal.pdf"), 
          width = 7, height = 7, 
...
```{r, eval = FALSE}
cairo_pdf(paste0(here::here(),"/Graficos/Estado/05_Migracion de retorno/2010/ChordDiagram de MRt para cada estado.pdf"), 
          width = 8,
          height = 8, 
          family = "Montserrat Medium",
          fallback_resolution = 400,
...
cairo_pdf(paste0(here::here(), "/Graficos/Estado/05_Migracion de retorno/2010/Etiquetas a nivel estatal.pdf"),
          width = 7, height = 8, 
          fallback_resolution = 400,
