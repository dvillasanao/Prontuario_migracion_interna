...
writeData(wb, 5, Indicadores("HLENGUA", df.claves = CVE_ENT, grupo = estados, Origen = "CVE_ENT", Destino = "ENT_PAIS_RES_5A", filtro = "EDAD >= 5 & EDAD <= 130"), colNames = TRUE)
writeData(wb, 6, Indicadores("PERETN", df.claves = CVE_ENT, grupo = estados, Origen = "CVE_ENT", Destino = "ENT_PAIS_RES_5A", filtro = "EDAD >= 5 & EDAD <= 130"), colNames = TRUE)
writeData(wb, 7, Indicadores("ALFABET", df.claves = CVE_ENT, grupo = estados, Origen = "CVE_ENT", Destino = "ENT_PAIS_RES_5A", filtro = "EDAD >= 5 & EDAD <= 130"), colNames = TRUE)
writeData(wb, 8, Indicadores("ESTCON", df.claves = CVE_ENT, grupo = estados, Origen = "CVE_ENT", Destino = "ENT_PAIS_RES_5A", filtro = "EDAD >= 5 & EDAD <= 130"), colNames = TRUE)
writeData(wb, 9, Indicadores("NIVACAD", df.claves = CVE_ENT, grupo = estados, Origen = "CVE_ENT", Destino = "ENT_PAIS_RES_5A", filtro = "EDAD >= 5 & EDAD <= 130"), colNames = TRUE)
saveWorkbook(wb, file = paste0(here::here(), "/Output/Estado/05_Migracion de retorno/2010/SDEM/Indicadores sociodemograficos a nivel estatal 2010.xlsx"), overwrite = TRUE)
```
...
writeData(wb, 5, Indicadores_P("HLENGUA", df.claves = CVE_ENT, grupo = estados, Origen = "CVE_ENT", Destino = "ENT_PAIS_RES_5A", filtro = "EDAD >= 5 & EDAD <= 130"), colNames = TRUE)
writeData(wb, 6, Indicadores_P("PERETN", df.claves = CVE_ENT, grupo = estados, Origen = "CVE_ENT", Destino = "ENT_PAIS_RES_5A", filtro = "EDAD >= 5 & EDAD <= 130"), colNames = TRUE)
writeData(wb, 7, Indicadores_P("ALFABET", df.claves = CVE_ENT, grupo = estados, Origen = "CVE_ENT", Destino = "ENT_PAIS_RES_5A", filtro = "EDAD >= 5 & EDAD <= 130"), colNames = TRUE)
writeData(wb, 8, Indicadores_P("ESTCON", df.claves = CVE_ENT, grupo = estados, Origen = "CVE_ENT", Destino = "ENT_PAIS_RES_5A", filtro = "EDAD >= 5 & EDAD <= 130"), colNames = TRUE)
writeData(wb, 9, Indicadores_P("NIVACAD", df.claves = CVE_ENT, grupo = estados, Origen = "CVE_ENT", Destino = "ENT_PAIS_RES_5A", filtro = "EDAD >= 5 & EDAD <= 130"), colNames = TRUE)
saveWorkbook(wb, file = paste0(here::here(), "/Output/Estado/05_Migracion de retorno/2010/SDEM/Indicadores sociodemograficos a nivel estatal 2010_Porcentajes.xlsx"), overwrite = TRUE)
```
