...
La variable `mydata` contiene **11 938 402** observaciones** y **20 variables**.

✔️A partir de aquí se pueden correr los códidos 👇.

Se carga el archivo `Migracion de lugar de nacimiento_2010.RData`.
...
writeData(wb, 5, Indicadores("HLENGUA", df.claves = CVE_ENT, grupo = estados, Origen = "CVE_ENT", Destino = "ENT_PAIS_NAC", filtro = "EDAD >= 0"), colNames = TRUE)
writeData(wb, 6, Indicadores("PERETN", df.claves = CVE_ENT, grupo = estados, Origen = "CVE_ENT", Destino = "ENT_PAIS_NAC", filtro = "EDAD >= 0"), colNames = TRUE)
writeData(wb, 7, Indicadores("ALFABET", df.claves = CVE_ENT, grupo = estados, Origen = "CVE_ENT", Destino = "ENT_PAIS_NAC", filtro = "EDAD >= 0"), colNames = TRUE)
writeData(wb, 8, Indicadores("ESTCON", df.claves = CVE_ENT, grupo = estados, Origen = "CVE_ENT", Destino = "ENT_PAIS_NAC", filtro = "EDAD >= 0"), colNames = TRUE)
writeData(wb, 9, Indicadores("NIVACAD", df.claves = CVE_ENT, grupo = estados, Origen = "CVE_ENT", Destino = "ENT_PAIS_NAC", filtro = "EDAD >= 0"), colNames = TRUE)
saveWorkbook(wb, file = paste0(here::here(), "/Output/Estado/02_Lugar de nacimiento/2010/SDEM/Indicadores sociodemograficos a nivel estatal 2010.xlsx"), overwrite = TRUE)
```
...
writeData(wb, 5, Indicadores_P("HLENGUA", df.claves = CVE_ENT, grupo = estados, Origen = "CVE_ENT", Destino = "ENT_PAIS_NAC", filtro = "EDAD >= 0"), colNames = TRUE)
writeData(wb, 6, Indicadores_P("PERETN", df.claves = CVE_ENT, grupo = estados, Origen = "CVE_ENT", Destino = "ENT_PAIS_NAC", filtro = "EDAD >= 0"), colNames = TRUE)
writeData(wb, 7, Indicadores_P("ALFABET", df.claves = CVE_ENT, grupo = estados, Origen = "CVE_ENT", Destino = "ENT_PAIS_NAC", filtro = "EDAD >= 0"), colNames = TRUE)
writeData(wb, 8, Indicadores_P("ESTCON", df.claves = CVE_ENT, grupo = estados, Origen = "CVE_ENT", Destino = "ENT_PAIS_NAC", filtro = "EDAD >= 0"), colNames = TRUE)
writeData(wb, 9, Indicadores_P("NIVACAD", df.claves = CVE_ENT, grupo = estados, Origen = "CVE_ENT", Destino = "ENT_PAIS_NAC", filtro = "EDAD >= 0"), colNames = TRUE)
saveWorkbook(wb, file = paste0(here::here(), "/Output/Estado/02_Lugar de nacimiento/2010/SDEM/Indicadores sociodemograficos a nivel estatal 2010_Porcentajes.xlsx"), overwrite = TRUE)
```
