...
save(Migrantes, file = paste0(here::here(), "/Bases/Estado/02_Lugar de nacimiento/2010/Matriz de migracion de nacimiento 2010.RData"))
```
...
load(file = paste0(here::here(), "/Bases/Estado/02_Lugar de nacimiento/2010/Matriz de migracion de nacimiento 2010.RData"))
...
p %>% 
 mapshot(url = paste0(here::here(),"/images/MNac_2010.html")) 
...
```{r}
file = "/Graficos/Estado/02_Lugar de nacimiento/2010/ChordDiagram de MNac a nivel estatal.pdf"
...
#p <- data.frame(estados = est,
 #               filtro_estados = filtro_mig,
  #               NUM = 1:32)
#write.xlsx(p, file = paste0(here::here(), "/Bases/Estado/02_Lugar de nacimiento/2010/Filtro a nivel estatal.xlsx"))

filtro_mig <- read.xlsx(paste0(here::here(), "/Bases/Estado/02_Lugar de nacimiento/2010/Filtro a nivel estatal.xlsx"), colNames = TRUE) %>% 
               pull(filtro_estados)
...
for(i in 1:32){
     ...
     saveWorkbook(wb, 
                  file = paste0(here::here(), "/Output/Estado/02_Lugar de nacimiento/2010/Matriz MNac por estados_2010_Reduccion.xlsx"), 
               overwrite = TRUE)
}
saveRDS(tabla1, file = paste0(here::here(), "/Output/Estado/02_Lugar de nacimiento/2010/Tabla MNac a por estados.RDS"))
```

```{r tablas de matrices}
tabla1 <- readRDS(file = paste0(here::here(), "/Output/Estado/02_Lugar de nacimiento/2010/Tabla MNac a por estados.RDS"))
...
for(i in 1:32){
     ...
     saveWorkbook(wb, 
                  file = paste0(here::here(), "/Output/Estado/02_Lugar de nacimiento/2010/Matriz MNac por estados_2010_Reduccion_Totales.xlsx"), 
               overwrite = TRUE)
}
```
...
file = "/Graficos/Estado/02_Lugar de nacimiento/2010/ChordDiagram de MNac para cada estado.pdf"
...
```{r etiquetas_estatal}
file = "/Graficos/Estado/02_Lugar de nacimiento/2010/Etiquetas a nivel estatal.pdf"
