 ...
 as.data.frame() %>%
   gt() %>% 
    fmt_integer(columns = 1, sep = " ") %>%
     tab_header(title = "Población total 2000") %>%
...
p %>% 
 mapshot(url = paste0(here::here(),"/images/MNac_2000.html")) 
...
```{r}
file = "/Graficos/Estado/02_Lugar de nacimiento/2000/ChordDiagram de MNac a nivel estatal.pdf"
...
file = "/Graficos/Estado/02_Lugar de nacimiento/2000/ChordDiagram de MNac para cada estado.pdf"
...
```{r etiquetas_estatal}
file = "/Graficos/Estado/02_Lugar de nacimiento/2000/Etiquetas a nivel estatal.pdf"
