---
title: "Migración por lugar de nacimiento 2000"
...
La variable `mydata` contiene **10 099 182** observaciones** y **20 variables**.   
✔️A partir de aquí se pueden correr los códidos 👇.

Se carga el archivo `Migracion de lugar de nacimiento_2000.RData`.
...
saveWorkbook(wb, file = paste0(here::here(), "/Output/Estado/02_Lugar de nacimiento/2000/SDEM/Indicadores sociodemograficos a nivel estatal 2000.xlsx"), overwrite = TRUE)
```
...
saveWorkbook(wb, file = paste0(here::here(), "/Output/Estado/02_Lugar de nacimiento/2000/SDEM/Indicadores sociodemograficos a nivel estatal 2000_Porcentajes.xlsx"), overwrite = TRUE)
```
