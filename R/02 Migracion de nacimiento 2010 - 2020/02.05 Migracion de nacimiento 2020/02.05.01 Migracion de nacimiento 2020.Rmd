...
require(mapview)
p %>% 
 mapshot(url = paste0(here::here(),"/Graficos/Estado/02_Lugar de nacimiento/2020/MNac a nivel estatal 2020.html"))
#require(webshot)
...
cairo_pdf(paste0(here::here(), "/Graficos/Estado/02_Lugar de nacimiento/2020/Etiquetas a nivel estatal.pdf"), 
          width = 7, height = 8, 
          fallback_resolution = 400,
