...
**Posibles variables que se pueden contemplar en la migración para toda la vida:**  
...
La variable `mydata` contiene **15 015 683 observaciones** y **20 variables**.  
...
saveWorkbook(wb, file = paste0(here::here(), "/Output/Estado/02_Lugar de nacimiento/2020/SDEM/Indicadores sociodemograficos a nivel estatal 2020.xlsx"), overwrite = TRUE)
```
...
saveWorkbook(wb, file = paste0(here::here(), "/Output/Estado/02_Lugar de nacimiento/2020/SDEM/Indicadores sociodemograficos a nivel estatal 2020_Porcentajes.xlsx"), overwrite = TRUE)
```
