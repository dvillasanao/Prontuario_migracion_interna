---
title: "Migración por lugar de nacimiento 2015"
...
La variable `mydata` contiene **22 692 265 observaciones** y **20 variables**.  

✔️A partir de aquí se pueden correr los códidos 👇.

Se carga el archivo `Migracion de lugar de nacimiento_2015.RData`.

```{r}
load(paste0(here::here(), "/Bases/02_Migracion de lugar de nacimiento_2015.RData"))
```
...
```{r, class.source = "fold-hide"}
Indicadores <- function(Variable, df.claves = CVE_ENT, grupo = estados,  Origen = "CVE_ENT", Destino = "ENT_PAIS_NAC", filtro = "EDAD >= 0"){
...
#tabla1 <- Indicadores("SEXO", df.claves = CVE_ENT, grupo = estados,  Origen = "CVE_ENT", Destino = "ENT_PAIS_NAC", filtro = "EDAD >= 0")
```

## Valores relativos

```{r, class.source = "fold-hide"}
Indicadores_P <- function(Variable, df.claves = CVE_ENT, grupo = estados,  Origen = "CVE_ENT", Destino = "ENT_PAIS_NAC", filtro = "EDAD >= 0"){
...
# Ejemplo
tabla <- Indicadores("SEXO", df.claves = CVE_ENT,  grupo = estados, Origen = "CVE_ENT", Destino = "ENT_PAIS_NAC", filtro = "EDAD >= 0")
```
...
writeData(wb, 1, Indicadores("SEXO", df.claves = CVE_ENT, grupo = estados, Origen = "CVE_ENT", Destino = "ENT_PAIS_NAC", filtro = "EDAD >= 0"), colNames = TRUE)
writeData(wb, 2, Indicadores("GEDAD", df.claves = CVE_ENT, grupo = estados, Origen = "CVE_ENT", Destino = "ENT_PAIS_NAC", filtro = "EDAD >= 0"), colNames = TRUE)
writeData(wb, 3, Indicadores("CONACT", df.claves = CVE_ENT, grupo = estados, Origen = "CVE_ENT", Destino = "ENT_PAIS_NAC", filtro = "EDAD >= 0"), colNames = TRUE)
writeData(wb, 4, Indicadores("PE", df.claves = CVE_ENT, grupo = estados, Origen = "CVE_ENT", Destino = "ENT_PAIS_NAC", filtro = "EDAD >= 0"), colNames = TRUE)
writeData(wb, 5, Indicadores("AFRODES", df.claves = CVE_ENT, grupo = estados, Origen = "CVE_ENT", Destino = "ENT_PAIS_NAC", filtro = "EDAD >= 0"), colNames = TRUE)
writeData(wb, 6, Indicadores("HLENGUA", df.claves = CVE_ENT, grupo = estados, Origen = "CVE_ENT", Destino = "ENT_PAIS_NAC", filtro = "EDAD >= 0"), colNames = TRUE)
writeData(wb, 7, Indicadores("PERTE_INDIGENA", df.claves = CVE_ENT, grupo = estados, Origen = "CVE_ENT", Destino = "ENT_PAIS_NAC", filtro = "EDAD >= 0"), colNames = TRUE)
writeData(wb, 8, Indicadores("ALFABET", df.claves = CVE_ENT, grupo = estados, Origen = "CVE_ENT", Destino = "ENT_PAIS_NAC", filtro = "EDAD >= 0"), colNames = TRUE)
writeData(wb, 9, Indicadores("SITUA_CONYUGAL", df.claves = CVE_ENT, grupo = estados, Origen = "CVE_ENT", Destino = "ENT_PAIS_NAC", filtro = "EDAD >= 0"), colNames = TRUE)
writeData(wb, 10, Indicadores("NIVACAD", df.claves = CVE_ENT, grupo = estados, Origen = "CVE_ENT", Destino = "ENT_PAIS_NAC", filtro = "EDAD >= 0"), colNames = TRUE)
saveWorkbook(wb, file = paste0(here::here(), "/Output/Estado/02_Lugar de nacimiento/2015/SDEM/Indicadores sociodemograficos a nivel estatal 2015.xlsx"), overwrite = TRUE)
```
...
addWorksheet(wb, "SITUA_CONYUGAL")
addWorksheet(wb, "NIVACAD")
writeData(wb, 1, Indicadores_P("SEXO", df.claves = CVE_ENT, grupo = estados, Origen = "CVE_ENT", Destino = "ENT_PAIS_NAC", filtro = "EDAD >= 0"), colNames = TRUE)
writeData(wb, 2, Indicadores_P("GEDAD", df.claves = CVE_ENT, grupo = estados, Origen = "CVE_ENT", Destino = "ENT_PAIS_NAC", filtro = "EDAD >= 0"), colNames = TRUE)
writeData(wb, 3, Indicadores_P("CONACT", df.claves = CVE_ENT, grupo = estados, Origen = "CVE_ENT", Destino = "ENT_PAIS_NAC", filtro = "EDAD >= 0"), colNames = TRUE)
writeData(wb, 4, Indicadores_P("PE", df.claves = CVE_ENT, grupo = estados, Origen = "CVE_ENT", Destino = "ENT_PAIS_NAC", filtro = "EDAD >= 0"), colNames = TRUE)
writeData(wb, 5, Indicadores_P("AFRODES", df.claves = CVE_ENT, grupo = estados, Origen = "CVE_ENT", Destino = "ENT_PAIS_NAC", filtro = "EDAD >= 0"), colNames = TRUE)
writeData(wb, 6, Indicadores_P("HLENGUA", df.claves = CVE_ENT, grupo = estados, Origen = "CVE_ENT", Destino = "ENT_PAIS_NAC", filtro = "EDAD >= 0"), colNames = TRUE)
writeData(wb, 7, Indicadores_P("PERTE_INDIGENA", df.claves = CVE_ENT, grupo = estados, Origen = "CVE_ENT", Destino = "ENT_PAIS_NAC", filtro = "EDAD >= 0"), colNames = TRUE)
writeData(wb, 8, Indicadores_P("ALFABET", df.claves = CVE_ENT, grupo = estados, Origen = "CVE_ENT", Destino = "ENT_PAIS_NAC", filtro = "EDAD >= 0"), colNames = TRUE)
writeData(wb, 9, Indicadores_P("SITUA_CONYUGAL", df.claves = CVE_ENT, grupo = estados, Origen = "CVE_ENT", Destino = "ENT_PAIS_NAC", filtro = "EDAD >= 0"), colNames = TRUE)
writeData(wb, 10, Indicadores_P("NIVACAD", df.claves = CVE_ENT, grupo = estados, Origen = "CVE_ENT", Destino = "ENT_PAIS_NAC", filtro = "EDAD >= 0"), colNames = TRUE)
saveWorkbook(wb, file = paste0(here::here(), "/Output/Estado/02_Lugar de nacimiento/2015/SDEM/Indicadores sociodemograficos a nivel estatal 2015_Porcentajes.xlsx"), overwrite = TRUE)
```
