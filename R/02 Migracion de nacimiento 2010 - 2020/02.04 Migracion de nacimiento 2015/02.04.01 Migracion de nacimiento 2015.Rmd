...
circos.clear()
pdf(paste0(here::here(),"/Graficos/Estado/02_Lugar de nacimiento/2015/ChordDiagram de MNac a nivel estatal.pdf"), width = 20, height = 20)
...
```{r, eval = FALSE}
circos.clear()
pdf(paste0(here::here(),"/Graficos/Estado/02_Lugar de nacimiento/2015/ChordDiagram de MNac para cada estado.pdf"), width = 20, height = 20)
