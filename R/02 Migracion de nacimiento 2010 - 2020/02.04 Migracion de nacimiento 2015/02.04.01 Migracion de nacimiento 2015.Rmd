...
mydata <- data %>%
           select(CVE_ENT, NOM_ENT, MUN, NOM_MUN, ENT_MUN, ENT_PAIS_NAC, EDAD, 
...
save(mydata, file = paste0(here::here(),"/Bases/02_Migracion de lugar de nacimiento_2015.RData"))
```
 ...
 as.data.frame() %>%
   gt() %>% 
    fmt_integer(columns = 1, sep = " ") %>%
     tab_header(title = "Población total 2015") %>%
...
saveRDS(MC, file = paste0(here::here(), "/Output/Estado/02_Lugar de nacimiento/2015/MC_estado.RDS"))
```
...
```{r}
MC <- readRDS(paste0(here::here(), "/Output/Estado/02_Lugar de nacimiento/2015/MC_estado.RDS"))
...
wb <- createWorkbook()
addWorksheet(wb, "MNac. 2015")
writeData(wb, 1, Migrantes, colNames = TRUE, rowNames = TRUE)
saveWorkbook(wb, file = paste0(here::here(), "/Bases/Estado/02_Lugar de nacimiento/2015/Matriz de migracion de nacimiento 2015.xlsx"), overwrite = TRUE)

save(Migrantes, file = paste0(here::here(), "/Bases/Estado/02_Lugar de nacimiento/2015/Matriz de migracion de nacimiento 2015.RData"))
```
...
load(file = paste0(here::here(), "/Bases/Estado/02_Lugar de nacimiento/2015/Matriz de migracion de nacimiento 2015.RData"))
...
p %>% 
 mapshot(url = paste0(here::here(),"/images/MNac_2015.html")) 

#htmlwidgets::saveWidget(p, paste0(here::here(),"/Graficos/Estado/02_Lugar de nacimiento/2015/MNac a nivel estatal 2015.html"), selfcontained = TRUE)
#require(webshot)
#webshot(url = paste0(here::here(),"/Graficos/Estado/02_Lugar de nacimiento/2015/MNac a nivel estatal 2015.html"),
 #         file = paste0(here::here(),"/Graficos/Estado/02_Lugar de nacimiento/2015/MNac a nivel estatal 2015.png"),
  #                cliprect = "viewport")
```
...
```{r}
file = "/Graficos/Estado/02_Lugar de nacimiento/2015/ChordDiagram de MNac a nivel estatal.pdf"
...
#p <- data.frame(estados = est,
 #               filtro_estados = filtro_mig,
  #               NUM = 1:32)
#write.xlsx(p, file = paste0(here::here(), "/Bases/Estado/02_Lugar de nacimiento/2015/Filtro a nivel estatal.xlsx"))

filtro_mig <- read.xlsx(paste0(here::here(), "/Bases/Estado/02_Lugar de nacimiento/2015/Filtro a nivel estatal.xlsx"), colNames = TRUE) %>% 
               pull(filtro_estados)
...
for(i in 1:32){
     ...
     saveWorkbook(wb, 
                  file = paste0(here::here(), "/Output/Estado/02_Lugar de nacimiento/2015/Matriz MNac por estados_2015_Reduccion.xlsx"), 
               overwrite = TRUE)
}
saveRDS(tabla1, file = paste0(here::here(), "/Output/Estado/02_Lugar de nacimiento/2015/Tabla MNac a por estados.RDS"))
```

```{r tablas de matrices}
tabla1 <- readRDS(file = paste0(here::here(), "/Output/Estado/02_Lugar de nacimiento/2015/Tabla MNac a por estados.RDS"))
...
for(i in 1:32){
     ...
     saveWorkbook(wb, 
                  file = paste0(here::here(), "/Output/Estado/02_Lugar de nacimiento/2015/Matriz MNac por estados_2015_Reduccion_Totales.xlsx"), 
               overwrite = TRUE)
}
```
...
file = "/Graficos/Estado/02_Lugar de nacimiento/2015/ChordDiagram de MNac para cada estado.pdf"
...
```{r etiquetas_estatal}
file = "/Graficos/Estado/02_Lugar de nacimiento/2015/Etiquetas a nivel estatal.pdf"
...
path = paste0(here::here(),"/Graficos/Estado/02_Lugar de nacimiento/2015/GSankey de MNac a nivel estatal.pdf")
...
path = paste0(here::here(),"/Graficos/Estado/02_Lugar de nacimiento/2015/GSankey de MNac desagregado por estados_Absolutos.pdf")
ggexport(list = p, width = 14, height = 10, dpi = 400, filename = path)
```
...
write.xlsx(tabla, file = paste0(here::here(),"/Output/Estado/02_Lugar de nacimiento/2015/Indicadores de migracion de nacimiento a nivel estatal 2015.xlsx"), overwrite = TRUE)

save(tabla, file = paste0(here::here(),"/Output/Estado/02_Lugar de nacimiento/2015/Indicadores de migracion de nacimiento a nivel estatal a nivel estatal 2015.RData"))
```

```{r, echo = FALSE, eval = TRUE}
load(file = paste0(here::here(),"/Output/Estado/02_Lugar de nacimiento/2015/Indicadores de migracion de nacimiento a nivel estatal a nivel estatal 2015.RData"))
