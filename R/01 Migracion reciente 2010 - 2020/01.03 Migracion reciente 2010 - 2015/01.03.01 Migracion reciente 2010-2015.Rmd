...
cairo_pdf(paste0(here::here(), "/Graficos/Estado/01_Migracion reciente/2015/ChordDiagram de MR5a a nivel estatal.pdf"), 
          width = 7, height = 7, 
...
cairo_pdf(paste0(here::here(), "/Graficos/Estado/01_Migracion reciente/2015/ChordDiagram de MR5a desagregado por estado.pdf"), 
          width = 8,
          height = 8, 
          family = "Montserrat Medium",
          fallback_resolution = 400,
...
cairo_pdf(paste0(here::here(), "/Graficos/Estado/01_Migracion reciente/2015/Etiquetas a nivel estatal.pdf"), 
          width = 7, height = 8, 
          fallback_resolution = 400,
...
```{r, echo = FALSE}
load(file = paste0(here::here(), "/Output/Municipio/01_Migracion reciente/2015/Indicadores de MR5a por estado 2010 - 2015.RData"))
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/01_Migracion reciente/2015/ChordDiagram de MR5a desagregado por estado.pdf"), 
          width = 15,
          height = 10, 
          family = "Montserrat Medium",
          fallback_resolution = 400,
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/01_Migracion reciente/2015/Etiquetas a nivel municipal.pdf"), 
          width = 7, height = 8, 
          fallback_resolution = 400,
          family = "montserrat", onefile = TRUE)
for(i in 1:length(estados)){
...
for(i in 1:32){
     ...
     writeData(wb, i, tabla, colNames = TRUE, rowNames = TRUE)
     saveWorkbook(wb, 
                  file = paste0(here::here(), "/Output/Municipio/01_Migracion reciente/2015/Matriz MTrab nivel intramunicipal_Reduccion.xlsx"), 
               overwrite = TRUE)
}
 
saveRDS(tabla1, file = paste0(here::here(), "/Output/Municipio/01_Migracion reciente/2015/Tabla MTrab a nivel intramunicipal.RDS"))
```

```{r tablas de matrices}
tabla1 <- readRDS(file = paste0(here::here(), "/Output/Municipio/01_Migracion reciente/2015/Tabla MTrab a nivel intramunicipal.RDS"))
...
for(i in 1:32){
     ...
     writeData(wb, i, porcentajes[[i]], colNames = TRUE, startCol = 5)
     saveWorkbook(wb, 
                  file = paste0(here::here(), "/Output/Municipio/01_Migracion reciente/2015/Matriz MTrab nivel intramunicipal_Reduccion_Totales.xlsx"), 
               overwrite = TRUE)
}
```
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/01_Migracion reciente/2015/ChordDiagram de MR5a desagregado a nivel intramunicipal.pdf"),
          width = 15,
          height = 10, 
          family = "Montserrat Medium",
          fallback_resolution = 400,
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/01_Migracion reciente/2015/Etiquetas a nivel intramunicipal.pdf"), 
          width = 7, height = 8, 
          fallback_resolution = 400,
          family = "montserrat", onefile = TRUE)
for(i in 1:length(estados)){
...
for(i in 1:32){
     ...
     writeData(wb, i, tabla, colNames = TRUE, rowNames = TRUE)
     saveWorkbook(wb, 
                  file = paste0(here::here(), "/Output/Municipio/01_Migracion reciente/2015/Matriz MTrab a nivel intermunicipal_Reduccion.xlsx"), 
               overwrite = TRUE)
}
...
for(i in 1:32){
     ...
     writeData(wb, i, porcentajes[[i]], colNames = TRUE, startCol = 5)
     saveWorkbook(wb, 
                  file = paste0(here::here(), "/Output/Municipio/01_Migracion reciente/2015/Matriz MTrab a nivel intermunicipal_Reduccion_Totales.xlsx"), 
               overwrite = TRUE)
}
```
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/01_Migracion reciente/2015/ChordDiagram de MR5a desagregado a nivel intermunicipal.pdf"),
          width = 15,
          height = 10, 
          family = "Montserrat Medium",
          fallback_resolution = 400,
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/01_Migracion reciente/2015/Etiquetas a nivel intermunicipal.pdf"), 
          width = 7, height = 8, 
          fallback_resolution = 400,
          family = "montserrat", onefile = TRUE)
for(i in 1:length(estados)){
...
```{r, echo = FALSE}
load(file = paste0(here::here(), "/Output/Municipio/01_Migracion reciente/2015/Indicadores de MR5a a nivel intermunicipal 2015.RData"))
