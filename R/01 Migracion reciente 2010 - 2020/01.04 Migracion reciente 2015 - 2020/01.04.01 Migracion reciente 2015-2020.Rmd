...
for(i in 1:32){
     ...
     writeData(wb, i, tabla, colNames = TRUE, rowNames = TRUE)
     saveWorkbook(wb, 
                  file = paste0(here::here(), "/Output/Municipio/01_Migracion reciente/2020/Matriz MR5a nivel intramunicipal_Reduccion.xlsx"), 
               overwrite = TRUE)
}
 
saveRDS(tabla1, file = paste0(here::here(), "/Output/Municipio/01_Migracion reciente/2020/Tabla MR5a a nivel intramunicipal.RDS"))
```

```{r tablas de matrices}
tabla1 <- readRDS(file = paste0(here::here(), "/Output/Municipio/01_Migracion reciente/2020/Tabla MR5a a nivel intramunicipal.RDS"))
...
for(i in 1:32){
     ...
     writeData(wb, i, porcentajes[[i]], colNames = TRUE, startCol = 5)
     saveWorkbook(wb, 
                  file = paste0(here::here(), "/Output/Municipio/01_Migracion reciente/2020/Matriz MR5a nivel intramunicipal_Reduccion_Totales.xlsx"), 
               overwrite = TRUE)
}
```
...
for(i in 1:32){
     ...
     writeData(wb, i, tabla, colNames = TRUE, rowNames = TRUE)
     saveWorkbook(wb, 
                  file = paste0(here::here(), "/Output/Municipio/01_Migracion reciente/2020/Matriz MR5a a nivel intermunicipal_Reduccion.xlsx"), 
               overwrite = TRUE)
}
...
for(i in 1:32){
     ...
     writeData(wb, i, porcentajes[[i]], colNames = TRUE, startCol = 5)
     saveWorkbook(wb, 
                  file = paste0(here::here(), "/Output/Municipio/01_Migracion reciente/2020/Matriz MR5a a nivel intermunicipal_Reduccion_Totales.xlsx"), 
               overwrite = TRUE)
}
```
