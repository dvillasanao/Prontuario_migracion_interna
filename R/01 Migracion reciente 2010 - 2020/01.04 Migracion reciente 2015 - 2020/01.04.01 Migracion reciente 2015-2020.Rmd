...
for(i in 1:32){
     ...
     saveWorkbook(wb, 
                  file = paste0(here::here(), "/Output/Estado/01_Migracion reciente/2020/Matriz MR5a por estados_2015 -2020_Reduccion_Totales.xlsx"), 
               overwrite = TRUE)
}
```
...
require(pals)
#Paleta1
colores <- colorRampPalette(pals::kovesi.linear_blue_5_95_c73(50))(50)
...
colores <- c("#170A3A", "#10082E", "#2F0F3E", "#3F1247", "#4D004B", "#501551", "#550252", "#660762", "#7D1D6B", "#871D62","#952664", "#AE2A5E", "#CA3F56", "#DB5854", "#DE5435", "#E45B2F", "#E86328", "#ED6B21", "#ED8861", "#F4A472", "#EBB969", "#E8B94B", "#D4A432")
...
for(i in 1:32){
     ...
     writeData(wb, i, porcentajes[[i]], colNames = TRUE, startCol = 5)
     saveWorkbook(wb, 
                  file = paste0(here::here(), "/Output/Municipio/01_Migracion reciente/2020/Matriz MR5a nivel municipal_Reduccion_Totales.xlsx"), 
               overwrite = TRUE)
}
```
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/01_Migracion reciente/2020/ChordDiagram de MR5a desagregado por estado.pdf"), 
          width = 15,
          height = 10, 
          family = "Montserrat Medium",
          fallback_resolution = 400,
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/01_Migracion reciente/2020/Etiquetas a nivel municipal.pdf"), 
          width = 7, height = 8, 
          fallback_resolution = 400,
          family = "montserrat", onefile = TRUE)
for(i in 1:length(estados)){
...
```{r tablas de matrices}
tabla1 <- readRDS(file = paste0(here::here(), "/Output/Municipio/01_Migracion reciente/2020/Tabla MTrab a nivel intramunicipal.RDS"))
...
for(i in 1:32){
     ...
     writeData(wb, i, porcentajes[[i]], colNames = TRUE, startCol = 5)
     saveWorkbook(wb, 
                  file = paste0(here::here(), "/Output/Municipio/01_Migracion reciente/2020/Matriz MTrab nivel intramunicipal_Reduccion_Totales.xlsx"), 
               overwrite = TRUE)
}
```
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/01_Migracion reciente/2020/ChordDiagram de MR5a desagregado a nivel intramunicipal.pdf"),
          width = 15,
          height = 10, 
          family = "Montserrat Medium",
          fallback_resolution = 400,
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/01_Migracion reciente/2020/Etiquetas a nivel intramunicipal.pdf"), 
          width = 7, height = 8, 
          fallback_resolution = 400,
          family = "montserrat", onefile = TRUE)
for(i in 1:length(estados)){
...
```{r tablas de matrices}
tabla1 <- readRDS(file = paste0(here::here(), "/Output/Municipio/01_Migracion reciente/2020/Tabla MR5a a nivel intermunicipal.RDS"))
...
for(i in 1:32){
     ...
     writeData(wb, i, porcentajes[[i]], colNames = TRUE, startCol = 5)
     saveWorkbook(wb, 
                  file = paste0(here::here(), "/Output/Municipio/01_Migracion reciente/2020/Matriz MTrab a nivel intermunicipal_Reduccion_Totales.xlsx"), 
               overwrite = TRUE)
}
```
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/01_Migracion reciente/2020/ChordDiagram de MR5a desagregado a nivel intermunicipal.pdf"),
          width = 15,
          height = 10, 
          family = "Montserrat Medium",
          fallback_resolution = 400,
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/01_Migracion reciente/2020/Etiquetas a nivel intermunicipal.pdf"), 
          width = 7, height = 8, 
          fallback_resolution = 400,
          family = "montserrat", onefile = TRUE)
for(i in 1:length(estados)){
