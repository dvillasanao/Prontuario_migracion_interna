---
title: "Migración reciente 2015 - 2020_SDEM"
...
mydata <- data %>%
           select(CVE_ENT, ENT, MUN, CVE_MUN, ENT_PAIS_RES_5A, MUN_RES_5A, CVE_MUN_RES15, EDAD, 
                  SEXO, AFRODES, HLENGUA, QDIALECT_INALI, PERTE_INDIGENA, NIVACAD, ESCOLARI, ESCOACUM, ALFABET, 
         ...
         mutate(CVE_MUN_RES = paste0(ENT_PAIS_RES_5A, MUN_RES_5A)) %>%
          mutate(ENT_PAIS_RES_5A = case_when(.$ENT_PAIS_RES_5A %in% estados ~.$ENT_PAIS_RES_5A,                                                                                                                               .$ENT_PAIS_RES_5A %nin% estados ~ "888", #Residencia en otro país
           ...
           mutate(I_Migracion = case_when(.$CVE_ENT == .$ENT_PAIS_RES_5A & .$ENT_PAIS_RES_5A %in% estados ~ 1, # Migrantes intramunicipales
                                          .$CVE_ENT != .$ENT_PAIS_RES_5A & .$ENT_PAIS_RES_5A %in% estados ~ 2, # Migrantes intramunicipales
...
writeData(wb, 11, Indicadores("NIVACAD"), colNames = TRUE)
writeData(wb, 12, Indicadores("G_ESCOACUM"), colNames = TRUE)
saveWorkbook(wb, file = paste0(here::here(), "/Output/Municipio/01_Migracion reciente/2020/SDEM/Indicadores sociodemograficos a nivel estatal 2020.xlsx"), overwrite = TRUE)
```
...
writeData(wb, 11, Indicadores_P("NIVACAD"), colNames = TRUE)
writeData(wb, 12, Indicadores_P("G_ESCOACUM"), colNames = TRUE)
saveWorkbook(wb, file = paste0(here::here(), "/Output/Municipio/01_Migracion reciente/2020/SDEM/Indicadores sociodemograficos a nivel estatal 2020_Porcentajes.xlsx"), overwrite = TRUE)
```
...
writeData(wb, 11, Indicadores("NIVACAD"), colNames = TRUE)
writeData(wb, 12, Indicadores("G_ESCOACUM"), colNames = TRUE)
saveWorkbook(wb, file = paste0(here::here(), "/Output/Municipio/01_Migracion reciente/2020/SDEM/Indicadores sociodemograficos a nivel intermunicipal 2020.xlsx"), overwrite = TRUE)
```
...
writeData(wb, 11, Indicadores_P("NIVACAD"), colNames = TRUE)
writeData(wb, 12, Indicadores_P("G_ESCOACUM"), colNames = TRUE)
saveWorkbook(wb, file = paste0(here::here(), "/Output/Municipio/01_Migracion reciente/2020/SDEM/Indicadores sociodemograficos a nivel intermunicipal 2020_Porcentajes.xlsx"), overwrite = TRUE)
```