...
writeData(wb, 4, Indicadores("AFRODES"), colNames = TRUE)
writeData(wb, 5, Indicadores("HLENGUA"), colNames = TRUE)
writeData(wb, 6, Indicadores("PERTE_INDIGENA"), colNames = TRUE)
writeData(wb, 7, Indicadores("ALFABET"), colNames = TRUE)
writeData(wb, 8, Indicadores("CAUSA_MIG"), colNames = TRUE)
writeData(wb, 9, Indicadores("SITUA_CONYUGAL"), colNames = TRUE)
writeData(wb, 10, Indicadores("NIVACAD"), colNames = TRUE)
writeData(wb, 11, Indicadores("G_ESCOACUM"), colNames = TRUE)
...
writeData(wb, 4, Indicadores_P("AFRODES"), colNames = TRUE)
writeData(wb, 5, Indicadores_P("HLENGUA"), colNames = TRUE)
writeData(wb, 6, Indicadores_P("PERTE_INDIGENA"), colNames = TRUE)
writeData(wb, 7, Indicadores_P("ALFABET"), colNames = TRUE)
writeData(wb, 8, Indicadores_P("CAUSA_MIG"), colNames = TRUE)
writeData(wb, 9, Indicadores_P("SITUA_CONYUGAL"), colNames = TRUE)
writeData(wb, 10, Indicadores_P("NIVACAD"), colNames = TRUE)
writeData(wb, 11, Indicadores_P("G_ESCOACUM"), colNames = TRUE)
