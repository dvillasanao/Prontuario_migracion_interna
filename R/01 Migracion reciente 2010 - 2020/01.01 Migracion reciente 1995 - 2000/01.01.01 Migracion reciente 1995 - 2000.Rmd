...
save(Migrantes, file = paste0(here::here(), "/Bases/Estado/01_Migracion reciente/2000/Matriz de migracion reciente a nivel estatal 2005-2000.RData"))

wb <- createWorkbook()
addWorksheet(wb, "MREst. 2005-2000")
writeData(wb, 1, Migrantes, colNames = TRUE, rowNames = TRUE)
saveWorkbook(wb, file = paste0(here::here(), "/Bases/Estado/01_Migracion reciente/2000/Matriz de migracion reciente a nivel estatal 2005-2000.xlsx"), overwrite = TRUE)
```

**Matriz de migración reciente hace 5 años a nivel estatal, 2005 - 2000**

::: {style="height:500px;overflow:auto;"}
```{r, echo = FALSE}
load(file = paste0(here::here(), "/Bases/Estado/01_Migracion reciente/2000/Matriz de migracion reciente a nivel estatal 2005-2000.RData"))
...
tabla %>%  
 gt() %>% 
  tab_header(title = "Matriz de migración reciente 2005 - 2000", 
...
p
require(htmlwidgets)
htmlwidgets::saveWidget(p, paste0(here::here(), "/Graficos/Estado/01_Migracion reciente/2000/MR5a a nivel estatal 2005 - 2000.html"), selfcontained = TRUE)
#require(webshot)
#webshot(url = paste0(here::here(), "/Graficos/Estado/01_Migracion reciente/2000/MR5a a nivel estatal 2005 - 2000.html"),
 #         file = paste0(here::here(), "/Graficos/Estado/01_Migracion reciente/2000/MR5a a nivel estatal 2005 - 2000.png"),
  #                cliprect = "viewport")
```
...
cairo_pdf(paste0(here::here(), "/Graficos/Estado/01_Migracion reciente/2000/ChordDiagram de MR5a a nivel estatal.pdf"), 
          width = 7, height = 7, 
...
for(i in 1:32){
     ...
     saveWorkbook(wb, 
                  file = paste0(here::here(), "/Output/Estado/01_Migracion reciente/2000/Matriz MR5a por estados_2005-2000_Reduccion.xlsx"), 
               overwrite = TRUE)
}
...
for(i in 1:32){
     ...
     saveWorkbook(wb, 
                  file = paste0(here::here(), "/Output/Estado/01_Migracion reciente/2000/Matriz MR5a por estados_2005-2000_Reduccion_Totales.xlsx"), 
               overwrite = TRUE)
}
```
...
cairo_pdf(paste0(here::here(), "/Graficos/Estado/01_Migracion reciente/2000/ChordDiagram de MR5a desagregado por estado.pdf"), 
          width = 8,
          height = 8, 
          family = "Montserrat Medium",
          fallback_resolution = 400,
...
cairo_pdf(paste0(here::here(), "/Graficos/Estado/01_Migracion reciente/2000/Etiquetas a nivel estatal.pdf"), 
          width = 7, height = 8, 
          fallback_resolution = 400,
...
write.xlsx(tabla, file = paste0(here::here(), "/Output/Estado/01_Migracion reciente/2000/Indicadores de MR5a por estado 2005 - 2000.xlsx"), overwrite = TRUE)
save(tabla, file = paste0(here::here(), "/Output/Municipio/01_Migracion reciente/2000/Indicadores de MR5a por estado 2005 - 2000.RData"))
```

```{r, echo = FALSE}
load(file = paste0(here::here(), "/Output/Municipio/01_Migracion reciente/2000/Indicadores de MR5a por estado 2005 - 2000.RData"))
...
**Matriz de migración reciente hace 5 años a nivel municipal, 2005 - 2000**
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/01_Migracion reciente/2000/ChordDiagram de MR5a desagregado por estado.pdf"), 
          width = 15,
          height = 10, 
          family = "Montserrat Medium",
          fallback_resolution = 400,
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/01_Migracion reciente/2000/Etiquetas a nivel municipal.pdf"), 
          width = 7, height = 8, 
          fallback_resolution = 400,
          family = "montserrat", onefile = TRUE)
for(i in 1:length(estados)){
...
write.xlsx(tabla, file = paste0(here::here(), "/Output/Municipio/01_Migracion reciente/2000/Indicadores de migracion reciente a nivel municipal 2005 - 2000.xlsx"), overwrite = TRUE)

save(tabla, file = paste0(here::here(), "/Output/Municipio/01_Migracion reciente/2000/Indicadores de migracion reciente a nivel municipal 2005 - 2000.RData"))
```

```{r, echo = FALSE}
load(file = paste0(here::here(), "/Output/Municipio/01_Migracion reciente/2000/Indicadores de migracion reciente a nivel municipal 2005 - 2000.RData"))
...
for(i in 1:32){
     ...
     writeData(wb, i, tabla, colNames = TRUE, rowNames = TRUE)
     saveWorkbook(wb, 
                  file = paste0(here::here(), "/Output/Municipio/01_Migracion reciente/2000/Matriz MTrab nivel intramunicipal_Reduccion.xlsx"), 
               overwrite = TRUE)
}
 
saveRDS(tabla1, file = paste0(here::here(), "/Output/Municipio/01_Migracion reciente/2000/Tabla MTrab a nivel intramunicipal.RDS"))
```

```{r tablas de matrices}
tabla1 <- readRDS(file = paste0(here::here(), "/Output/Municipio/01_Migracion reciente/2000/Tabla MTrab a nivel intramunicipal.RDS"))
...
for(i in 1:32){
     ...
     writeData(wb, i, porcentajes[[i]], colNames = TRUE, startCol = 5)
     saveWorkbook(wb, 
                  file = paste0(here::here(), "/Output/Municipio/01_Migracion reciente/2000/Matriz MTrab nivel intramunicipal_Reduccion_Totales.xlsx"), 
               overwrite = TRUE)
}
```
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/01_Migracion reciente/2000/ChordDiagram de MR5a desagregado a nivel intramunicipal.pdf"),
          width = 15,
          height = 10, 
          family = "Montserrat Medium",
          fallback_resolution = 400,
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/01_Migracion reciente/2000/Etiquetas a nivel intramunicipal.pdf"), 
          width = 7, height = 8, 
          fallback_resolution = 400,
          family = "montserrat", onefile = TRUE)
for(i in 1:length(estados)){
...
```{r, echo = FALSE}
load(file = paste0(here::here(), "/Output/Municipio/01_Migracion reciente/2000/Indicadores de MR5a a nivel intramunicipal 2000.RData"))
...
for(i in 1:32){
     ...
     writeData(wb, i, tabla, colNames = TRUE, rowNames = TRUE)
     saveWorkbook(wb, 
                  file = paste0(here::here(), "/Output/Municipio/01_Migracion reciente/2000/Matriz MTrab a nivel intermunicipal_Reduccion.xlsx"), 
               overwrite = TRUE)
}
...
for(i in 1:32){
     ...
     writeData(wb, i, porcentajes[[i]], colNames = TRUE, startCol = 5)
     saveWorkbook(wb, 
                  file = paste0(here::here(), "/Output/Municipio/01_Migracion reciente/2000/Matriz MTrab a nivel intermunicipal_Reduccion_Totales.xlsx"), 
               overwrite = TRUE)
}
```
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/01_Migracion reciente/2000/ChordDiagram de MR5a desagregado a nivel intermunicipal.pdf"),
          width = 15,
          height = 10, 
          family = "Montserrat Medium",
          fallback_resolution = 400,
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/01_Migracion reciente/2000/Etiquetas a nivel intermunicipal.pdf"), 
          width = 7, height = 8, 
          fallback_resolution = 400,
          family = "montserrat", onefile = TRUE)
for(i in 1:length(estados)){
...
```{r, echo = FALSE}
load(file = paste0(here::here(), "/Output/Municipio/01_Migracion reciente/2000/Indicadores de MR5a a nivel intermunicipal 2000.RData"))
