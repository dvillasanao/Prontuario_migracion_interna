...
tabla %>%  
 gt() %>% 
  tab_header(title = "Matriz de migración reciente 1995-2000", 
...
```{r, echo = FALSE}
load(file = paste0(here::here(), "/Output/Municipio/01_Migracion reciente/2000/Indicadores de MR5a por estado 1995-2000.RData"))
...
```{r, echo = FALSE}
load(file = paste0(here::here(), "/Output/Municipio/01_Migracion reciente/2000/Indicadores de migracion reciente a nivel municipal 1995-2000.RData"))
