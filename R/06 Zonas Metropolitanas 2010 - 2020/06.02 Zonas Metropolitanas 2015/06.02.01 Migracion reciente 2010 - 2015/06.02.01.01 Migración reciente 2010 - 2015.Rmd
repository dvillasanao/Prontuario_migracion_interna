...
subtitle: 'Migración reciente 2010 - 2015'
...
mydata <- mydata %>%
           select(CVE_ENT, NOM_ENT, CVE_MUN, NOM_MUN, ENT_PAIS_RES10, CVE_MUN_RES, 
...
MC <- mydata %>%
       select(CVE_ENT, CVE_MUN, ENT_PAIS_RES10, CVE_MUN_RES, CVE_ZM, CVE_ZM_RES, M, EDAD, FACTOR, ESTRATO, UPM) %>%
...
saveRDS(MC, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/MC_municipal.RDS"))
```

```{r, eval = FALSE}
MC <- readRDS(file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/MC_municipal.RDS"))
...
saveRDS(Migrantes, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Matriz de migracion reciente a nivel municipal.RDS"))
save(Migrantes, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Matriz de migracion reciente a nivel municipal.RData"))

require(openxlsx)
wb <- createWorkbook()
addWorksheet(wb, "M.Reciente")
writeData(wb, 1, Migrantes %>% as.data.frame() %>% tibble::rownames_to_column(var = "CVE_MUN"), colNames = TRUE)
saveWorkbook(wb, file = paste0(here::here(), "/Bases/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Matriz de migracion reciente a nivel municipal.xlsx"), overwrite = TRUE)
```
...
load(paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Matriz de migracion reciente a nivel municipal.RData"))
...
tabla[1:30, 1:30] %>%  
 gt() %>% 
  tab_header(title = "Matriz de migración reciente 2010 - 2015", 
...
#write.xlsx(p, file = paste0(here::here(), "/Bases/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Filtro a nivel municipal.xlsx"), overwrite = TRUE)

#### Filtro de municipios
filtro_mig <- read.xlsx(paste0(here::here(), "/Bases/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Filtro a nivel municipal.xlsx"), colNames = TRUE) %>%
               pull(filtro_municipio)

#### Filtro de estados 
filtro_out <- read.xlsx(paste0(here::here(), "/Bases/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Filtro a nivel municipal.xlsx"), colNames = TRUE) %>%
               pull(filtro_estado)
...
for(i in 1:length(ZM)){
     ...
     saveWorkbook(wb, 
                  file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Matriz MR5a a nivel municipal_Reduccion.xlsx"), 
               overwrite = TRUE)
}

saveRDS(tabla1, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Tabla MR5a a nivel municipal.RDS"))
```

```{r tablas de matrices nivel municipal}
tabla1 <- readRDS(file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Tabla MR5a a nivel municipal.RDS"))
...
for(i in 1:length(ZM)){
     ...
     saveWorkbook(wb, 
                  file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Matriz MR5a a nivel municipal_Reduccion_Totales.xlsx"), 
               overwrite = TRUE)
}
```
...
file = "/Graficos/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/ChordDiagram de MR5a desagregado por ZM.pdf"
...
file = "/Graficos/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Etiquetas a nivel municipal.pdf"
...
path = paste0(here::here(),"/Graficos/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/GSankey de MR5a desagregado por ZM_Absolutos.pdf")
...
file = "/Graficos/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/ChordDiagram de MR5a de ZMVM.pdf"
...
saveWorkbook(wb, 
              file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Matriz MR5a de ZMVM a nivel municipal_Reduccion.xlsx"), 
               overwrite = TRUE)
```
...
file = "/Graficos/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/ChordDiagram de MR5a de ZMVM_grupos.pdf"
...
```{r}
file = "/Graficos/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Etiquetas ZMVM a nivel municipal.pdf"
...
path = paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/GSankey de MR5a de la ZMVM.pdf")
...
################################################################################
########################### Residentes #########################################
load(file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Matriz de migracion reciente a nivel municipal.RData"))
...
write.xlsx(tabla, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Indicadores de MR5a por ZM 2015.xlsx"), overwrite = TRUE)
save(tabla, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Indicadores de MR5a por ZM 2015.RData"))
```

```{r, echo = FALSE, eval = TRUE}
load(file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Indicadores de MR5a por ZM 2015.RData"))

tabla[1:20,] %>%  
 as.data.frame() %>%
  gt() %>% 
   tab_header(title = "Indicadores de  migración reciente a nivel municipal",  
...
saveRDS(MC, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/MC_intramunicipal.RDS"))
```
...
```{r, eval = FALSE}
MC <- readRDS(file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/MC_intramunicipal.RDS"))
...
saveRDS(Migrantes, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Matriz de migracion reciente a nivel intramunicipal 2015.RDS"))
save(Migrantes, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Matriz de migracion reciente a nivel intramunicipal 2015.RData"))

require(openxlsx)
wb <- createWorkbook()
addWorksheet(wb, "M.Intramunicipal")
writeData(wb, 1, Migrantes %>% as.data.frame() %>% tibble::rownames_to_column(var = "CVE_MUN"), colNames = TRUE)
saveWorkbook(wb, file = paste0(here::here(), "/Bases/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Matriz de migracion reciente a nivel intramunicipal 2015.xlsx"), overwrite = TRUE)
```
...
```{r, echo = FALSE, eval = TRUE}
load(paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Matriz de migracion reciente a nivel intramunicipal 2015.RData"))
...
saveRDS(MR, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Matrices de MR5a a nivel intramunicipal por ZM2015.RDS"))
...
saveWorkbook(wb, 
              file = paste0(here::here(), "/Bases/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Matrices de MR5a a nivel intramunicipal por ZM2015.xlsx"), 
               overwrite = TRUE)
}
```

**Matriz de migración reciente hace 5 años en la Zona Metropolitana de Cuernavaca, 2010 - 2015**

::: {style="height:500px;overflow:auto;"}
```{r, echo = FALSE, eval = TRUE}
MR <- readRDS(paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Matrices de MR5a a nivel intramunicipal por ZM2015.RDS"))
...
#p <- data.frame(ZM = ZM_CF,
#                filtro_municipio = tabla_municipios)
#write.xlsx(p, file = paste0(here::here(), "/Bases/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Filtro a nivel intramunicipal.xlsx"), overwrite = TRUE)

#### Filtro de municipios
filtro_mig <- read.xlsx(paste0(here::here(), "/Bases/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Filtro a nivel intramunicipal.xlsx"), colNames = TRUE) %>%
               pull(filtro_municipio)
...
for(i in 1:length(ZM_CF)){
     ...
     writeData(wb, i, tabla, colNames = TRUE, rowNames = TRUE)
     saveWorkbook(wb, 
                  file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Matriz MR5a a nivel intramunicipal_Reduccion.xlsx"), 
               overwrite = TRUE)
}

saveRDS(tabla1, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Matriz MR5a a nivel intramunicipal.RDS"))
```

```{r tablas de matrices nivel intramunicipal}
tabla1 <- readRDS(file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Matriz MR5a a nivel intramunicipal.RDS"))
...
for(i in 1:length(ZM)){
     ...
     writeData(wb, i, porcentajes_tablas[[i]], colNames = TRUE, startCol = 5)
     saveWorkbook(wb, 
                  file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Matriz MR5a a nivel intramunicipal_Reduccion_Totales.xlsx"), 
               overwrite = TRUE)
}
```
...
file = "/Graficos/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/ChordDiagram de MR5a desagregado por ZM (Intramunicipal).pdf"
...
file = "/Graficos/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Etiquetas ZM a nivel intramunicipal.pdf"
...
path = paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/GSankey de MR5a desagregado por ZM_Absolutos (Intramunicipal).pdf")
...
file = "/Graficos/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/ChordDiagram de MR5a de ZMVM (Intramunicipal).pdf"
...
writeData(wb, 1, tabla, colNames = TRUE, rowNames = TRUE)
saveWorkbook(wb, 
              file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Matriz MR5a de ZMVM a nivel intramunicipal_Reduccion.xlsx"), 
               overwrite = TRUE)
```
...
file = "/Graficos/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/ChordDiagram de MR5a de ZMVM_grupos (Intramunicipal).pdf"
...
```{r}
file = "/Graficos/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Etiquetas ZMVM a nivel intramunicipal.pdf"
...
path = paste0(here::here(),"/Graficos/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/GSankey de MR5a de la ZMVM (Intramunicipal).pdf")
ggexport(p, width = 20, height = 12, dpi = 400, filename = path)
```
...
################################################################################
########################### Residentes #########################################
load(file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Matriz de migracion reciente a nivel intramunicipal 2015.RData"))
...
write.xlsx(tabla, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Indicadores de MR5a por ZM 2015 (Intramunicipal).xlsx"), overwrite = TRUE)

save(tabla, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Indicadores de MR5a por ZM 2015 (Intramunicipal).RData"))
```

```{r, echo = FALSE, eval = TRUE}
load(file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Indicadores de MR5a por ZM 2015 (Intramunicipal).RData"))

tabla[1:20,] %>%  
 as.data.frame() %>%
  gt() %>% 
   tab_header(title = "Indicadores de  migración reciente a nivel intramunicipal",  
              subtitle = "Zonas Metropolitanas") %>%
    tab_options(heading.title.font.size = 12, 
                heading.align = "center",
                heading.subtitle.font.size = 10,
...
saveRDS(MC, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/MC_intermunicipal.RDS"))
```

Se genera una matriz cruzada del lugar de residencia hace 5 años a nivel municipal, utilizando la función `svytable` de la paquetería `survey`.

```{r, eval = FALSE}
MC <- readRDS(file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/MC_intermunicipal.RDS"))
...
saveRDS(Migrantes, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Matriz de migracion reciente a nivel intermunicipal 2015.RDS"))
save(Migrantes, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Matriz de migracion reciente a nivel intermunicipal 2015.RData"))

require(openxlsx)
wb <- createWorkbook()
addWorksheet(wb, "M.Intermunicipal")
writeData(wb, 1, Migrantes %>% as.data.frame() %>% tibble::rownames_to_column(var = "CVE_MUN"), colNames = TRUE)
saveWorkbook(wb, file = paste0(here::here(), "/Bases/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Matriz de migracion reciente a nivel intermunicipal 2015.xlsx"), overwrite = TRUE)
```

**Matriz de migración reciente hace 5 años a nivel intermunicipal, 2010 - 2015**

::: {style="height:500px;overflow:auto;"}
```{r, echo = FALSE, eval = TRUE}
load(paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Matriz de migracion reciente a nivel intermunicipal 2015.RData"))
...
#write.xlsx(p, file = paste0(here::here(), "/Bases/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Filtro a nivel intermunicipal.xlsx"), overwrite = TRUE)

#### Filtro de municipios
filtro_mig <- read.xlsx(paste0(here::here(), "/Bases/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Filtro a nivel intermunicipal.xlsx"), colNames = TRUE) %>%
               pull(filtro_municipio)

#### Filtro de estados 
filtro_out <- read.xlsx(paste0(here::here(), "/Bases/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Filtro a nivel intermunicipal.xlsx"), colNames = TRUE) %>%
               pull(filtro_estado)
...
for(i in 1:length(ZM)){
     ...
     writeData(wb, i, tabla, colNames = TRUE, rowNames = TRUE)
     saveWorkbook(wb, 
                  file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Matriz MR5a a nivel intermunicipal_Reduccion.xlsx"), 
               overwrite = TRUE)
}

saveRDS(tabla1, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Tabla MR5a a nivel intermunicipal.RDS"))
```

```{r tablas de matrices nivel intermunicipal}
tabla1 <- readRDS(file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Tabla MR5a a nivel intermunicipal.RDS"))
...
for(i in 1:length(ZM)){
     ...
     writeData(wb, i, porcentajes_tablas[[i]], colNames = TRUE, startCol = 5)
     saveWorkbook(wb, 
                  file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Matriz MR5a a nivel intermunicipal_Reduccion_Totales.xlsx"), 
               overwrite = TRUE)
}
```
...
file = "/Graficos/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/ChordDiagram de MR5a desagregado por ZM (Intermunicipal).pdf"
...
file = "/Graficos/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Etiquetas ZM a nivel intermunicipal.pdf"
...
path = paste0(here::here(),"/Graficos/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/GSankey de MR5a desagregado por ZM_Absolutos (Intermunicipal).pdf")
ggexport(list = p, width = 18, height = 10, dpi = 400, filename = path)
```
...
file = "/Graficos/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/ChordDiagram de MR5a de ZMVM (Intermunicipal).pdf"
...
writeData(wb, 1, tabla, colNames = TRUE, rowNames = TRUE)
saveWorkbook(wb, 
              file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Matriz MR5a de ZMVM a nivel intermunicipal_Reduccion.xlsx"), 
               overwrite = TRUE)
```
...
file = "/Graficos/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/ChordDiagram de MR5a de ZMVM_grupos (Intermunicipal).pdf"
...
path = paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/GSankey de MR5a de la ZMVM (Intermunicipal).pdf")
ggexport(p, width = 20, height = 12, dpi = 400, filename = path)
```
...
################################################################################
########################### Residentes #########################################
load(file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Matriz de migracion reciente a nivel intermunicipal 2015.RData"))
...
write.xlsx(tabla, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Indicadores de MR5a por ZM 2015 (Intermunicipal).xlsx"), overwrite = TRUE)

save(tabla, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Indicadores de MR5a por ZM 2015 (Intermunicipal).RData"))
```

```{r, echo = FALSE, eval = TRUE}
load(file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Indicadores de MR5a por ZM 2015 (Intermunicipal).RData"))

tabla[1:20,] %>%  
 as.data.frame() %>%
  gt() %>% 
   tab_header(title = "Indicadores de  migración reciente a nivel intermunicipal",  
              subtitle = "Zonas Metropolitanas") %>%
    tab_options(heading.title.font.size = 12, 
                heading.align = "center",
                heading.subtitle.font.size = 10,
...
saveRDS(MC, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/MC_metropolitana.RDS"))
```
...
```{r, eval = FALSE}
MC <- readRDS(file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/MC_metropolitana.RDS"))
...
saveRDS(Migrantes, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Matriz de MR5a a nivel metropolitano 2015.RDS"))
save(Migrantes, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Matriz de MR5a a nivel metropolitano 2015.RData"))

require(openxlsx)
wb <- createWorkbook()
addWorksheet(wb, "M.Metropolitano")
writeData(wb, 1, Migrantes %>% as.data.frame() %>% tibble::rownames_to_column(var = "CVE_ZM"), colNames = TRUE)
saveWorkbook(wb, file = paste0(here::here(), "/Bases/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Matriz de MR5a a nivel metropolitano 2015.xlsx"), overwrite = TRUE)
```
...
::: {style="height:500px;overflow:auto;"}
```{r, echo = FALSE, eval = TRUE}
load(paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Matriz de MR5a a nivel metropolitano 2015.RData"))
...
file = "/Graficos/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/ChordDiagram de MR5a desagregado por ZM (metropolitano).pdf"
...
#write.xlsx(p, file = paste0(here::here(), "/Bases/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Filtro a nivel metropolitano.xlsx"), overwrite = TRUE)

#### Filtro de municipios
filtro_mig <- read.xlsx(paste0(here::here(), "/Bases/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Filtro a nivel metropolitano.xlsx"), colNames = TRUE) %>%
               pull(filtro_zm)
...
for(i in 1:length(ZM)){
     ...
     writeData(wb, i, tabla, colNames = TRUE, rowNames = TRUE)
     saveWorkbook(wb, 
                  file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Matriz MR5a a nivel metropolitano_Reduccion.xlsx"), 
               overwrite = TRUE)
}

saveRDS(tabla1, paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Matriz MR5a a nivel metropolitano.RDS"))
```

```{r tablas de matrices nivel metropolitano}
tabla1 <- readRDS(file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Matriz MR5a a nivel metropolitano.RDS"))
...
for(i in 1:length(ZM)){
     ...
     writeData(wb, i, porcentajes_tablas[[i]], colNames = TRUE, startCol = 5)
     saveWorkbook(wb, 
                  file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Matriz MR5a a nivel metropolitano_Reduccion_Totales.xlsx"), 
               overwrite = TRUE)
}
```

```{r, eval = FALSE}
tabla1 <- readRDS(paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Matriz MR5a a nivel metropolitano.RDS"))
...
file = "/Graficos/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/ChordDiagram de MR5a desagregado por ZM (metropolitano)_individual.pdf"
...
file = "/Graficos/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Etiquetas ZM a nivel metropolitano.pdf"
...
write.xlsx(tabla, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Indicadores de MR5a por ZM 2015 (Metropolitano) 2015.xlsx"), overwrite = TRUE)
save(tabla, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Indicadores de MR5a por ZM 2015 (Metropolitano) 2015.RData"))
```

```{r, echo = FALSE, eval = TRUE}
load(file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Indicadores de MR5a por ZM 2015 (Metropolitano) 2015.RData"))

tabla[1:20,] %>%  
 as.data.frame() %>%
  gt() %>% 
   tab_header(title = "Indicadores de  migración reciente (Nivel metropolitano)",  
              subtitle = "Zonas Metropolitanas") %>%
    tab_options(heading.title.font.size = 12, 
                heading.align = "center",
                heading.subtitle.font.size = 10,
...
## Migración intrametropolitana {.tabset .tabset-pills}
...
saveRDS(MC, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/MC_intrametropolitana.RDS"))
```
...
write.xlsx(tabla, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Indicadores de MR5a por ZM 2015 (Intrametropolitano) 2015.xlsx"), overwrite = TRUE)
save(tabla, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Indicadores de MR5a por ZM 2015 (Intrametropolitano) 2015.RData"))
```

```{r, echo = FALSE, eval = TRUE}
load(file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Indicadores de MR5a por ZM 2015 (Intrametropolitano) 2015.RData"))

tabla[1:20,] %>%  
 as.data.frame() %>%
  gt() %>% 
   tab_header(title = "Indicadores de  migración reciente (Nivel intrametropolitano)",  
              subtitle = "Zonas Metropolitanas") %>%
    tab_options(heading.title.font.size = 12, 
                heading.align = "center",
                heading.subtitle.font.size = 10,
...
## Migración intermetropolitana {.tabset .tabset-pills}
...
saveRDS(MC, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/MC_intermetropolitana.RDS"))
```
...
write.xlsx(tabla, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Indicadores de MR5a por ZM 2015 (Intermetropolitano) 2015.xlsx"), overwrite = TRUE)
save(tabla, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Indicadores de MR5a por ZM 2015 (Intermetropolitano) 2015.RData"))
```

```{r, echo = FALSE, eval = TRUE}
load(file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Indicadores de MR5a por ZM 2015 (Intermetropolitano) 2015.RData"))

tabla[1:20,] %>%  
 as.data.frame() %>%
  gt() %>% 
   tab_header(title = "Indicadores de  migración reciente (Nivel intermetropolitano)",  
              subtitle = "Zonas Metropolitanas") %>%
    tab_options(heading.title.font.size = 12, 
                heading.align = "center",
                heading.subtitle.font.size = 10,
