...
**Matriz de migración reciente hace 5 años a nivel municipal, 2015 - 2015**
...
tabla[1:30, 1:30] %>%  
 gt() %>% 
  tab_header(title = "Matriz de migración reciente 2015 - 2015", 
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/ChordDiagram de MR5a desagregado por ZM.pdf"), 
          width = 15,
          height = 10, 
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Etiquetas a nivel municipal.pdf"), 
          width = 7, height = 9, 
          fallback_resolution = 400,
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/ChordDiagram de MR5a de ZMVM.pdf"), 
          width = 7, height = 7, 
          family = "Montserrat Medium",
          fallback_resolution = 400,
          onefile = TRUE)
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/ChordDiagram de MR5a de ZMVM_grupos.pdf"), 
          width = 10, height = 10, 
          family = "Montserrat Medium",
          fallback_resolution = 400,
          onefile = TRUE)
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Etiquetas ZMVM a nivel municipal.pdf"), 
          width = 7, height = 9, 
          fallback_resolution = 400,
          family = "montserrat", onefile = TRUE)
for(i in 1){
...
**Matriz de migración reciente hace 5 años en la Zona Metropolitana de Cuernavaca, 2015 - 2015**  
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/ChordDiagram de MR5a desagregado por ZM (Intramunicipal).pdf"), 
          width = 15,
          height = 10, 
          family = "Montserrat Medium",
          fallback_resolution = 400,
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Etiquetas ZM a nivel intramunicipal.pdf"), 
          width = 7, height = 8, 
          fallback_resolution = 400,
          family = "montserrat", onefile = TRUE)
for(i in 1:length(ZM_CF)){
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/ChordDiagram de MR5a de ZMVM (Intramunicipal).pdf"), 
          width = 7, height = 7, 
          family = "Montserrat Medium",
          fallback_resolution = 400,
          onefile = TRUE)
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/ChordDiagram de MR5a de ZMVM_grupos (Intramunicipal).pdf"), 
          width = 10, height = 10, 
          family = "Montserrat Medium",
          fallback_resolution = 400,
          onefile = TRUE)
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Etiquetas ZMVM a nivel intramunicipal.pdf"), 
          width = 7, height = 8, 
          fallback_resolution = 400,
          family = "montserrat", onefile = TRUE)
for(i in 1){
...
**Matriz de migración reciente hace 5 años a nivel intermunicipal, 2015 - 2015**  
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/ChordDiagram de MR5a desagregado por ZM (Intermunicipal).pdf"), 
          width = 15,
          height = 10, 
          family = "Montserrat Medium",
          fallback_resolution = 400,
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Etiquetas ZM a nivel intermunicipal.pdf"), 
          width = 7, height = 9, 
          fallback_resolution = 400,
          family = "montserrat", onefile = TRUE)
for(i in 1:length(ZM_CF)){
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/ChordDiagram de MR5a de ZMVM (Intermunicipal).pdf"), 
          width = 7, height = 7, 
          family = "Montserrat Medium",
          fallback_resolution = 400,
          onefile = TRUE)
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/ChordDiagram de MR5a de ZMVM_grupos (Intermunicipal).pdf"), 
          width = 10, height = 10, 
          family = "Montserrat Medium",
          fallback_resolution = 400,
          onefile = TRUE)
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Etiquetas ZMVM a nivel intermunicipal.pdf"),
          width = 7, height = 9, 
          fallback_resolution = 400,
          family = "montserrat", onefile = TRUE)
for(i in 1){
...
MC <- mydata %>%
       select(CVE_ENT, CVE_MUN, ENT_PAIS_RES10, MUN_RES_5A, CVE_MUN_RES, CVE_ZM, MC, CF, CVE_ZM_RES, M, EDAD, FACTOR, ESTRATO, UPM) %>%
        # Se genera una indicadora de zm 
        mutate(I_ZM_2015 = ifelse(is.na(.$CVE_ZM), '0', '1'),
               I_RES5A_ZM_2015 = ifelse(is.na(.$CVE_ZM_RES), '0', '1')) %>%
        # Se clasifican a los migrantes internos 
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/ChordDiagram de MR5a desagregado por ZM (metropolitano).pdf"), 
          width = 10, height = 10, 
          family = "Montserrat Medium",
          fallback_resolution = 400,
          onefile = TRUE)
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/ChordDiagram de MR5a desagregado por ZM (metropolitano)_individual.pdf"), 
          width = 8,
          height = 8, 
          family = "Montserrat Medium",
          fallback_resolution = 400,
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2015/01_Migracion reciente/Etiquetas ZM a nivel metropolitano.pdf"), 
          width = 7, height = 8, 
          fallback_resolution = 400,
          family = "montserrat", onefile = TRUE)
for(i in 1:length(ZM_CF)){
