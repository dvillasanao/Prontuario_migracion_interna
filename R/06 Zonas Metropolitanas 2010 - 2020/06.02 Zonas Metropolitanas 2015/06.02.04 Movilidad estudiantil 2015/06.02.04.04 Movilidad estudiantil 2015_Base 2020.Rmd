...
#saveRDS(MUN, file = paste0(here::here(), "/Bases/municipios_2015_Base 2020.RDS"))
...
saveRDS(MC, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/04_Movilidad estudiantil/Base 2020/MC_municipal_Base 2020.RDS"))
```
...
```{r, eval = FALSE}
MC <- readRDS(file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/04_Movilidad estudiantil/Base 2020/MC_municipal_Base 2020.RDS"))
...
saveRDS(Migrantes, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/04_Movilidad estudiantil/Base 2020/Matriz de Movilidad estudiantil a nivel municipal 2015_Base 2020.RDS"))
save(Migrantes, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/04_Movilidad estudiantil/Base 2020/Matriz de Movilidad estudiantil a nivel municipal 2015_Base 2020.RData"))

require(openxlsx)
wb <- createWorkbook()
addWorksheet(wb, "M.Municipal")
writeData(wb, 1, Migrantes %>% as.data.frame() %>% tibble::rownames_to_column(var = "CVE_MUN"), colNames = TRUE)
saveWorkbook(wb, file = paste0(here::here(), "/Bases/Municipio/06_Zonas Metropolitanas/2015/04_Movilidad estudiantil/Base 2020/Matriz de Movilidad estudiantil a nivel municipal 2015_Base 2020.xlsx"), overwrite = TRUE)
```
...
```{r, echo = FALSE, eval = TRUE}
load(paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/04_Movilidad estudiantil/Base 2020/Matriz de Movilidad estudiantil a nivel municipal 2015_Base 2020.RData"))
...
tabla[1:30, 1:30] %>%  
 gt() %>% 
  tab_header(title = "Matriz de movilidad estudiantil a nivel municipal", 
...
################################################################################
########################### Residentes #########################################
load(file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/04_Movilidad estudiantil/Base 2020/Matriz de Movilidad estudiantil a nivel municipal 2015_Base 2020.RData"))
...
write.xlsx(tabla, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/04_Movilidad estudiantil/Base 2020/Indicadores de MEst por ZM 2015 (municipal)_Base 2020.xlsx"), overwrite = TRUE)

save(tabla, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/04_Movilidad estudiantil/Base 2020/Indicadores de MEst por ZM 2015 (municipal)_Base 2020.RData"))
```

```{r, echo = FALSE, eval = TRUE}
load(file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/04_Movilidad estudiantil/Base 2020/Indicadores de MEst por ZM 2015 (municipal)_Base 2020.RData"))

tabla[1:20,] %>%  
 as.data.frame() %>%
  gt() %>% 
   tab_header(title = "Indicadores de  movilidad estudiantil a nivel municipal",  
              subtitle = "Zonas Metropolitanas") %>%
    tab_options(heading.title.font.size = 12, 
                heading.align = "center",
                heading.subtitle.font.size = 10,
...
saveRDS(MC, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/04_Movilidad estudiantil/Base 2020/MC_intramunicipal_Base 2020.RDS"))
```
...
```{r, eval = FALSE}
MC <- readRDS(file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/04_Movilidad estudiantil/Base 2020/MC_intramunicipal_Base 2020.RDS"))
...
saveRDS(Migrantes, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/04_Movilidad estudiantil/Base 2020/Matriz de Movilidad estudiantil a nivel intramunicipal 2015_Base 2020.RDS"))
save(Migrantes, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/04_Movilidad estudiantil/Base 2020/Matriz de Movilidad estudiantil a nivel intramunicipal 2015_Base 2020.RData"))

require(openxlsx)
wb <- createWorkbook()
addWorksheet(wb, "M.Intramunicipal")
writeData(wb, 1, Migrantes %>% as.data.frame() %>% tibble::rownames_to_column(var = "CVE_MUN"), colNames = TRUE)
saveWorkbook(wb, file = paste0(here::here(), "/Bases/Municipio/06_Zonas Metropolitanas/2015/04_Movilidad estudiantil/Base 2020/Matriz de Movilidad estudiantil a nivel intramunicipal 2015_Base 2020.xlsx"), overwrite = TRUE)
```
...
<div style="height:500px;overflow:auto;">
```{r, echo = FALSE, eval = TRUE}
load(paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/04_Movilidad estudiantil/Base 2020/Matriz de Movilidad estudiantil a nivel intramunicipal 2015_Base 2020.RData"))
...
saveRDS(MR, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/04_Movilidad estudiantil/Base 2020/Matrices de MEst a nivel intramunicipal por ZM2015_Base 2020.RDS"))
...
saveWorkbook(wb, 
              file = paste0(here::here(), "/Bases/Municipio/06_Zonas Metropolitanas/2015/04_Movilidad estudiantil/Base 2020/Matrices de MEst a nivel intramunicipal por ZM2015_Base 2020.xlsx"), 
               overwrite = TRUE)
}
```
...
<div style="height:500px;overflow:auto;">
```{r, echo = FALSE, eval = TRUE}
MR <- readRDS(paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/04_Movilidad estudiantil/Base 2020/Matrices de MEst a nivel intramunicipal por ZM2015_Base 2020.RDS"))
...
################################################################################
########################### Residentes #########################################
load(file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/04_Movilidad estudiantil/Base 2020/Matriz de Movilidad estudiantil a nivel intramunicipal 2015_Base 2020.RData"))
...
write.xlsx(tabla, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/04_Movilidad estudiantil/Base 2020/Indicadores de MEst por ZM 2015 (Intramunicipal)_Base 2020.xlsx"), overwrite = TRUE)

save(tabla, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/04_Movilidad estudiantil/Base 2020/Indicadores de MEst por ZM 2015 (Intramunicipal)_Base 2020.RData"))
```

```{r, echo = FALSE, eval = TRUE}
load(file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/04_Movilidad estudiantil/Base 2020/Indicadores de MEst por ZM 2015 (Intramunicipal)_Base 2020.RData"))

tabla[1:20,] %>%  
 as.data.frame() %>%
  gt() %>% 
   tab_header(title = "Indicadores de  movilidad estudiantil a nivel intramunicipal",  
              subtitle = "Zonas Metropolitanas") %>%
    tab_options(heading.title.font.size = 12, 
                heading.align = "center",
                heading.subtitle.font.size = 10,
...
saveRDS(MC, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/04_Movilidad estudiantil/Base 2020/MC_intermunicipal_Base 2020.RDS"))
```
...
```{r, eval = FALSE}
MC <- readRDS(file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/04_Movilidad estudiantil/Base 2020/MC_intermunicipal_Base 2020.RDS"))
...
saveRDS(Migrantes, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/04_Movilidad estudiantil/Base 2020/Matriz de Movilidad estudiantil a nivel intermunicipal 2015_Base 2020.RDS"))
save(Migrantes, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/04_Movilidad estudiantil/Base 2020/Matriz de Movilidad estudiantil a nivel intermunicipal 2015_Base 2020.RData"))

require(openxlsx)
wb <- createWorkbook()
addWorksheet(wb, "M.Intermunicipal")
writeData(wb, 1, Migrantes %>% as.data.frame() %>% tibble::rownames_to_column(var = "CVE_MUN"), colNames = TRUE)
saveWorkbook(wb, file = paste0(here::here(), "/Bases/Municipio/06_Zonas Metropolitanas/2015/04_Movilidad estudiantil/Base 2020/Matriz de Movilidad estudiantil a nivel intermunicipal 2015_Base 2020.xlsx"), overwrite = TRUE)
```
...
<div style="height:500px;overflow:auto;">
```{r, echo = FALSE, eval = TRUE}
load(paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/04_Movilidad estudiantil/Base 2020/Matriz de Movilidad estudiantil a nivel intermunicipal 2015_Base 2020.RData"))
...
tabla[1:30, 1:30] %>%  
 gt() %>% 
  tab_header(title = "Matriz de movilidad estudiantil a nivel intermunicipal", 
             subtitle = "Zonas Metropolitanas") %>%
   tab_options(heading.title.font.size = 12, 
               heading.align = "center",
               heading.subtitle.font.size = 10,
...
################################################################################
########################### Residentes #########################################
load(file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/04_Movilidad estudiantil/Base 2020/Matriz de Movilidad estudiantil a nivel intermunicipal 2015_Base 2020.RData"))
...
write.xlsx(tabla, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/04_Movilidad estudiantil/Base 2020/Indicadores de MEst por ZM 2015 (Intermunicipal)_Base 2020.xlsx"), overwrite = TRUE)

save(tabla, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/04_Movilidad estudiantil/Base 2020/Indicadores de MEst por ZM 2015 (Intermunicipal)_Base 2020.RData"))
```

```{r, echo = FALSE}
load(file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/04_Movilidad estudiantil/Base 2020/Indicadores de MEst por ZM 2015 (Intermunicipal)_Base 2020.RData"))

tabla[1:20,] %>%  
 as.data.frame() %>%
  gt() %>% 
   tab_header(title = "Indicadores de movilidad estudiantil a nivel intermunicipal",  
              subtitle = "Zonas Metropolitanas") %>%
    tab_options(heading.title.font.size = 12, 
                heading.align = "center",
                heading.subtitle.font.size = 10,
...
saveRDS(MC, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/04_Movilidad estudiantil/Base 2020/MC_metropolitana_Base 2020.RDS"))
```
...
```{r, eval = FALSE}
MC <- readRDS(file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/04_Movilidad estudiantil/Base 2020/MC_metropolitana_Base 2020.RDS"))
...
saveRDS(Migrantes, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/04_Movilidad estudiantil/Base 2020/Matriz de Movilidad estudiantil a nivel metropolitano 2015_Base 2020.RDS"))
save(Migrantes, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/04_Movilidad estudiantil/Base 2020/Matriz de Movilidad estudiantil a nivel metropolitano 2015_Base 2020.RData"))

require(openxlsx)
wb <- createWorkbook()
addWorksheet(wb, "M.Metropolitano")
writeData(wb, 1, Migrantes %>% as.data.frame() %>% tibble::rownames_to_column(var = "CVE_ZM"), colNames = TRUE)
saveWorkbook(wb, file = paste0(here::here(), "/Bases/Municipio/06_Zonas Metropolitanas/2015/04_Movilidad estudiantil/Base 2020/Matriz de Movilidad estudiantil a nivel metropolitano 2015_Base 2020.xlsx"), overwrite = TRUE)
```
...
<div style="height:500px;overflow:auto;">
```{r, echo = FALSE, eval = TRUE}
load(paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/04_Movilidad estudiantil/Base 2020/Matriz de Movilidad estudiantil a nivel metropolitano 2015_Base 2020.RData"))
...
write.xlsx(tabla, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/04_Movilidad estudiantil/Base 2020/Indicadores de MEst por ZM 2015 (Metropolitano) 2015_Base 2020.xlsx"), overwrite = TRUE)
save(tabla, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/04_Movilidad estudiantil/Base 2020/Indicadores de MEst por ZM 2015 (Metropolitano) 2015_Base 2020.RData"))
```

```{r, echo = FALSE, eval = TRUE}
load(file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/04_Movilidad estudiantil/Base 2020/Indicadores de MEst por ZM 2015 (Metropolitano) 2015_Base 2020.RData"))

tabla[1:20,] %>%  
 as.data.frame() %>%
  gt() %>% 
   tab_header(title = "Indicadores de  movilidad estudiantil a nivel metropolitano",  
              subtitle = "Zonas Metropolitanas") %>%
    tab_options(heading.title.font.size = 12, 
                heading.align = "center",
                heading.subtitle.font.size = 10,
...
saveRDS(MC, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/04_Movilidad estudiantil/Base 2020/MC_intrametropolitana_Base 2020.RDS"))
```
...
write.xlsx(tabla, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/04_Movilidad estudiantil/Base 2020/Indicadores de MEst por ZM 2015 (Intrametropolitano) 2015_Base 2020.xlsx"), overwrite = TRUE)
save(tabla, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/04_Movilidad estudiantil/Base 2020/Indicadores de MEst por ZM 2015 (Intrametropolitano) 2015_Base 2020.RData"))
```

```{r, echo = FALSE, eval = TRUE}
load(file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/04_Movilidad estudiantil/Base 2020/Indicadores de MEst por ZM 2015 (Intrametropolitano) 2015_Base 2020.RData"))

tabla[1:20,] %>%  
 as.data.frame() %>%
  gt() %>% 
   tab_header(title = "Indicadores de  movilidad estudiantil a nivel intrametropolitano",  
              subtitle = "Zonas Metropolitanas") %>%
    tab_options(heading.title.font.size = 12, 
                heading.align = "center",
                heading.subtitle.font.size = 10,
...
saveRDS(MC, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/04_Movilidad estudiantil/Base 2020/MC_intermetropolitana_Base 2020.RDS"))
```
...
write.xlsx(tabla, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/04_Movilidad estudiantil/Base 2020/Indicadores de MEst por ZM 2015 (Intermetropolitano) 2015_Base 2020.xlsx"), overwrite = TRUE)
save(tabla, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/04_Movilidad estudiantil/Base 2020/Indicadores de MEst por ZM 2015 (Intermetropolitano) 2015_Base 2020.RData"))
```

```{r, echo = FALSE, eval = TRUE}
load(file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2015/04_Movilidad estudiantil/Base 2020/Indicadores de MEst por ZM 2015 (Intermetropolitano) 2015_Base 2020.RData"))

tabla[1:20,] %>%  
 as.data.frame() %>%
  gt() %>% 
   tab_header(title = "Indicadores de  movilidad estudiantil a nivel intermetropolitano",  
              subtitle = "Zonas Metropolitanas") %>%
    tab_options(heading.title.font.size = 12, 
                heading.align = "center",
                heading.subtitle.font.size = 10,
