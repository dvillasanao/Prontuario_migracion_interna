...
```{r, eval = FALSE}
ZM_2020 <- read_Base2020.xlsx(paste0(here::here(), "/Bases/Municipio/ZM_2020.xlsx"), 
                      startRow = 7, 
                       skipEmptyRows = TRUE) %>%
...
load(paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2010/01_Migracion reciente/Base 2020/Matriz de migracion reciente a nivel municipal_Base2020.RData"))
...
################################################################################
########################### Residentes #########################################
load(file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2010/01_Migracion reciente/Base 2020/Matriz de migracion reciente a nivel intermunicipal_Base2020.RData"))
...
write_Base2020.xlsx(tabla, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2010/01_Migracion reciente/Base 2020/Indicadores de MR5a por ZM 2010_Base2020.xlsx"), overwrite = TRUE)
...
```{r, echo = FALSE, eval = TRUE}
load(file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2010/01_Migracion reciente/Base 2020/Indicadores de MR5a por ZM 2010_Base2020.RData"))
...
```{r, echo = FALSE, eval = TRUE}
load(paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2010/01_Migracion reciente/Base 2020/Matriz de migracion reciente a nivel intramunicipal 2010_Base2020.RData"))
...
```{r, echo = FALSE, eval = TRUE}
load(file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2010/01_Migracion reciente/Base 2020/Indicadores de MR5a por ZM 2010 (Intramunicipal)_Base2020.RData"))
...
::: {style="height:500px;overflow:auto;"}
```{r, echo = FALSE, eval = TRUE}
load(paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2010/01_Migracion reciente/Base 2020/Matriz de migracion reciente a nivel intermunicipal 2010_Base2020.RData"))
...
write_Base2020.xlsx(tabla, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2010/01_Migracion reciente/Base 2020/Indicadores de MR5a por ZM 2010 (Intermunicipal)_Base2020.xlsx"), overwrite = TRUE)
...
```{r, echo = FALSE, eval = TRUE}
load(file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2010/01_Migracion reciente/Base 2020/Indicadores de MR5a por ZM 2010 (Intermunicipal)_Base2020.RData"))
...
::: {style="height:500px;overflow:auto;"}
```{r, echo = FALSE, eval = TRUE}
load(paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2010/01_Migracion reciente/Base 2020/Matriz de MR5a a nivel metropolitano 2010_Base2020.RData"))
...
write_Base2020.xlsx(tabla, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2010/01_Migracion reciente/Base 2020/Indicadores de MR5a por ZM 2010 (Metropolitano) 2010_Base2020.xlsx"), overwrite = TRUE)
...
```{r, echo = FALSE, eval = TRUE}
load(file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2010/01_Migracion reciente/Base 2020/Indicadores de MR5a por ZM 2010 (Metropolitano) 2010_Base2020.RData"))
...
write_Base2020.xlsx(tabla, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2010/01_Migracion reciente/Base 2020/Indicadores de MR5a por ZM 2010 (Intrametropolitano) 2010_Base2020.xlsx"), overwrite = TRUE)
...
```{r, echo = FALSE, eval = TRUE}
load(file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2010/01_Migracion reciente/Base 2020/Indicadores de MR5a por ZM 2010 (Intrametropolitano) 2010_Base2020.RData"))
...
write_Base2020.xlsx(tabla, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2010/01_Migracion reciente/Base 2020/Indicadores de MR5a por ZM 2010 (Intermetropolitano) 2010_Base2020.xlsx"), overwrite = TRUE)
...
```{r, echo = FALSE, eval = TRUE}
load(file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2010/01_Migracion reciente/Base 2020/Indicadores de MR5a por ZM 2010 (Intermetropolitano) 2010_Base2020.RData"))
