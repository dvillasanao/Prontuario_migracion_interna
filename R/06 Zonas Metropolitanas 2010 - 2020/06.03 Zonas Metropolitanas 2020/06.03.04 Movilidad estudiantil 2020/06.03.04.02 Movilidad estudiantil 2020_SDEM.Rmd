...
mydata <- mydata %>%
           ...
           select(CVE_ENT, NOM_ENT, MUN, CVE_MUN, NOM_MUN,ENT_PAIS_ASI, MUN_ASI, CVE_MUN_ASI, 
                  EDAD, SEXO, AFRODES, HLENGUA, PERTE_INDIGENA, ALFABET, NIVACAD, ESCOLARI, ESCOACUM,  
                  NOMCAR_C, TIE_TRASLADO_ESCU, MED_TRASLADO_ESC1, MED_TRASLADO_ESC2, MED_TRASLADO_ESC3,
                  CVE_ZM, NOM_ZM, CVE_ZM_ASI, ZM_ASI, FACTOR, ESTRATO, UPM) %>%
