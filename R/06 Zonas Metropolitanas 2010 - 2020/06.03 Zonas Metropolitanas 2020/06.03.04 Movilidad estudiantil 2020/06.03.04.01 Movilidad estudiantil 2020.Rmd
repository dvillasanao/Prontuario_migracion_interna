...
MC <- mydata %>%
       select(CVE_ENT, NOM_ENT, MUN, CVE_MUN, NOM_MUN, ENT_PAIS_ASI, MUN_ASI, CVE_MUN_ASI,
        ...
        mutate(I_ZM = case_when(.$CVE_ZM == .$CVE_ZM_ASI ~ "Pertenecen a la Zona Metropolitana",
                                .$CVE_ZM != .$CVE_ZM_ASI ~ "No pertenecen a la Zona Metropolitana")) %>%
...
#write.table(p, file = paste0(here::here(), "/Bases/Municipio/06_Zonas Metropolitanas/2020/04_Movilidad estudiantil/Filtro a nivel municipal.txt"),
 #           col.names = TRUE)
                                          ...
                                          filter(.$rn %in% ZM[[x]] | .$cn %in% ZM[[x]]) %>%
                                           mutate(value = ifelse((.$rn != .$cn) & (.$rn %in% ZM[[x]] | .$cn %in% ZM[[x]]), value, 0)) %>% 
                                            mutate(rn = case_when(.$rn %in% ZM[[x]] & .$rn %in% filtro  ~ .$rn,
                                                                  .$rn %in% ZM[[x]] & .$rn %nin% filtro ~ str_wrap(paste(estados[as.numeric(substr(.$rn, 1, 3))], "ZMVM"), 20),
                                                                  .$rn %nin% ZM[[x]] & substr(.$rn, 1, 3) %in% filtro_est ~ str_wrap(paste0(nom_estados[as.numeric(substr(.$rn, 1, 3))]), 20),
                                                                  .$rn %nin% ZM[[x]] & substr(.$rn, 1, 3) %nin% filtro_est ~ "Otros estados"),
                                                 
                                                   cn = case_when(.$cn %in% ZM[[x]] & .$cn %in% filtro  ~ .$cn,
                                                                  .$cn %in% ZM[[x]] & .$cn %nin% filtro ~ str_wrap(paste(estados[as.numeric(substr(.$cn, 1, 3))], "ZMVM"), 20),
                                                                  .$cn %nin% ZM[[x]] & substr(.$cn, 1, 3) %in% filtro_est ~ str_wrap(paste0(nom_estados[as.numeric(substr(.$cn, 1, 3))]), 20),
...
pdf(paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2020/04_Movilidad estudiantil/ChordDiagram de MEst desagregado por ZM (municipal).pdf"), width = 27, height = 25)
...
path = paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2020/04_Movilidad estudiantil/Etiquetas ZM a nivel municipal.pdf")
...
circos.clear()
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2020/04_Movilidad estudiantil/ChordDiagram de MEst de ZMVM (municipal).pdf"), width = 20, height = 18)
circos.par(start.degree = 90, 
           gap.degree = 3, 
...
circos.clear()
pdf(paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2020/04_Movilidad estudiantil/ChordDiagram de MEst de ZMVM_grupos (municipal).pdf"), width = 18, height = 15)
circos.par(start.degree = 90, 
           gap.degree = 3, 
...
path = paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2020/04_Movilidad estudiantil/Etiquetas ZMVM a nivel municipal.pdf")
ggexport(etiquetas, width = 5, height = 5, dpi = 400, filename = path)
```
...
```{r, eval = FALSE, results='hide'}
pdf(paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2020/04_Movilidad estudiantil/ChordDiagram de MEst desagregado por ZM (Intramunicipal).pdf"), width = 25, height = 25)
for(i in 1:length(ZM_CF)){
circos.clear()
circos.par(start.degree = 90, 
           gap.degree = 3, 
...
path = paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2020/04_Movilidad estudiantil/Etiquetas ZM a nivel intramunicipal.pdf")
...
circos.clear()
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2020/04_Movilidad estudiantil/ChordDiagram de MEst de ZMVM (Intramunicipal).pdf"), width = 18, height = 15)
circos.par(start.degree = 90, 
           gap.degree = 3, 
           track.margin = c(-0.1, 0.1), 
           points.overflow.warning = FALSE)
...
circos.clear()
pdf(paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2020/04_Movilidad estudiantil/ChordDiagram de MEst de ZMVM_grupos (Intramunicipal).pdf"), width = 18, height = 15)
circos.par(start.degree = 90, 
           gap.degree = 3, 
           track.margin = c(-0.2, 0.2), 
           points.overflow.warning = FALSE)
...
path = paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2020/04_Movilidad estudiantil/Etiquetas ZMVM a nivel intramunicipal.pdf")
ggexport(etiquetas, width = 5, height = 5, dpi = 400, filename = path)
```
...
#p <- data.frame(ZM = ZM_CF,
 #               filtro_municipio = filtro_mig,
  #              filtro_estado = filtro_out)
#write.table(p, file = paste0(here::here(), "/Bases/Municipio/06_Zonas Metropolitanas/2020/04_Movilidad estudiantil/Filtro a nivel intermunicipal.txt"), col.names = TRUE)
...
## Se sacan los flujos migratorios que pertencen a otros estados
tabla_estados <- sapply(1:length(ZM), function(i){
                                        tabla1[[i]] %>%
                                         as.data.frame() %>%
                                          adorn_totals(c("row", "col"), 
                                                       fill = "-", 
...
```{r, eval = FALSE, results='hide'}
pdf(paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2020/04_Movilidad estudiantil/ChordDiagram de MEst desagregado por ZM (Intermunicipal).pdf"), width = 25, height = 25)
for(i in 1:length(ZM)){
circos.clear()
circos.par(start.degree = 90, 
           gap.degree = 2, 
...
path = paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2020/04_Movilidad estudiantil/Etiquetas ZM a nivel intermunicipal.pdf")
ggexport(etiquetas, width = 5, height = 5, dpi = 400, filename = path)
```
...
```{r}
pdf(paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2020/04_Movilidad estudiantil/ChordDiagram de MEst de ZMVM (Intermunicipal).pdf"), width = 18, height = 15)
circos.clear()
circos.par(start.degree = 90, 
           gap.degree = 3, 
           track.margin = c(-0.1, 0.1), 
...
# Grupo 4
grupo4 <- tabla %>%
           filter(substr(.$cn, 1, 3) %nin% c("009", "013", "015")) %>%
            arrange(cn) %>%
             pull(cn) %>%
              unique()
...
writeData(wb, 1, tabla, colNames = TRUE, rowNames = TRUE)
saveWorkbook(wb, 
              file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2020/04_Movilidad estudiantil/Matriz MTrab de ZMVM a nivel intermunicipal_Reduccion.xlsx"), 
               overwrite = TRUE)
```


```{r}
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2020/04_Movilidad estudiantil/ChordDiagram de MEst de ZMVM_grupos (Intermunicipal).pdf"), width = 18, height = 15)
circos.clear()
circos.par(start.degree = 90, 
           gap.degree = 2, 
           track.margin = c(-0.2, 0.2), 
...
path = paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2020/04_Movilidad estudiantil/Etiquetas ZMVM a nivel intermunicipal.pdf")
ggexport(etiquetas, width = 5, height = 5, dpi = 400, filename = path)
```
...
```{r, eval = FALSE, results='hide'}
pdf(paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2020/04_Movilidad estudiantil/ChordDiagram de MEst desagregado por ZM (metropolitano).pdf"), width = 25, height = 25)
for(i in 1){
circos.clear()
circos.par(start.degree = 90, 
           gap.degree = 3, 
...
```{r, eval = FALSE, results='hide'}
pdf(paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2020/04_Movilidad estudiantil/ChordDiagram de MEst desagregado por ZM (metropolitano)_individual.pdf"), width = 25, height = 25)
for(i in 1:length(ZM)){
circos.clear()
circos.par(start.degree = 90, 
           gap.degree = 3, 
...
path = paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2020/04_Movilidad estudiantil/Etiquetas ZM a nivel metropolitano.pdf")
ggexport(etiquetas, width = 5, height = 5, dpi = 400, filename = path)
```
