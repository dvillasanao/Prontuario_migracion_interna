...
saveWorkbook(wb, file = paste0(here::here(),  "/Output/Municipio/06_Zonas Metropolitanas/2020/01_Migracion reciente/SDEM/Indicadores sociodemograficos a nivel metropolitano 2020.xlsx"), overwrite = TRUE)
```
...
saveWorkbook(wb, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2020/01_Migracion reciente/SDEM/Indicadores sociodemograficos a nivel metropolitano 2020_Porcentajes.xlsx"), overwrite = TRUE)
```
...
writeData(wb, 11, Indicadores("NIVACAD"), colNames = TRUE)
writeData(wb, 12, Indicadores("G_ESCOACUM"), colNames = TRUE)
saveWorkbook(wb, file = paste0(here::here(),  "/Output/Municipio/06_Zonas Metropolitanas/2020/01_Migracion reciente/SDEM/Indicadores sociodemograficos a nivel intrametropolitano 2020.xlsx"), overwrite = TRUE)
```
...
writeData(wb, 11, Indicadores_P("NIVACAD"), colNames = TRUE)
writeData(wb, 12, Indicadores_P("G_ESCOACUM"), colNames = TRUE)
saveWorkbook(wb, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2020/01_Migracion reciente/SDEM/Indicadores sociodemograficos a nivel intrametropolitano 2020_Porcentajes.xlsx"), overwrite = TRUE)
```
...
writeData(wb, 11, Indicadores("NIVACAD"), colNames = TRUE)
writeData(wb, 12, Indicadores("G_ESCOACUM"), colNames = TRUE)
saveWorkbook(wb, file = paste0(here::here(),  "/Output/Municipio/06_Zonas Metropolitanas/2020/01_Migracion reciente/SDEM/Indicadores sociodemograficos a nivel intermetropolitano 2020.xlsx"), overwrite = TRUE)
```
...
writeData(wb, 11, Indicadores_P("NIVACAD"), colNames = TRUE)
writeData(wb, 12, Indicadores_P("G_ESCOACUM"), colNames = TRUE)
saveWorkbook(wb, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2020/01_Migracion reciente/SDEM/Indicadores sociodemograficos a nivel intermetropolitano 2020_Porcentajes.xlsx"), overwrite = TRUE)
```
