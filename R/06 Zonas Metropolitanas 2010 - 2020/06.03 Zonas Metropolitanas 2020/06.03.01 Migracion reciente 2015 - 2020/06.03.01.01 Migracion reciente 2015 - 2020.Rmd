...
MC <- mydata %>%
       select(CVE_ENT, CVE_MUN, ENT_PAIS_RES_5A, MUN_RES_5A, CVE_MUN_RES, CVE_ZM, MC, CF, CVE_ZM_RES, M, EDAD, FACTOR, ESTRATO, UPM) %>%
        mutate(I_ZM = case_when(.$CVE_ZM == .$CVE_ZM_RES ~ "Pertenecen a la Zona Metropolitana",
                                 .$CVE_ZM != .$CVE_ZM_RES ~ "No pertenecen a la Zona Metropolitana")) %>%
...
#write.table(p, file = paste0(here::here(), "/Bases/Municipio/06_Zonas Metropolitanas/2020/01_Migracion reciente/Filtro a nivel municipal.txt"),
 #           col.names = TRUE)
                                          ...
                                          filter(.$rn %in% ZM[[x]] | .$cn %in% ZM[[x]]) %>%
                                           mutate(value = ifelse((.$rn != .$cn) & (.$rn %in% ZM[[x]] | .$cn %in% ZM[[x]]), value, 0)) %>% 
                                            mutate(rn = case_when(.$rn %in% ZM[[x]] & .$rn %in% filtro  ~ .$rn,
                                                                  .$rn %in% ZM[[x]] & .$rn %nin% filtro ~ str_wrap(paste(estados[as.numeric(substr(.$rn, 1, 3))], "ZM"), 50),
                                                   ...
                                                   cn = case_when(.$cn %in% ZM[[x]] & .$cn %in% filtro  ~ .$cn,
                                                                  .$cn %in% ZM[[x]] & .$cn %nin% filtro ~ str_wrap(paste(estados[as.numeric(substr(.$cn, 1, 3))], "ZM"), 50),
...
pdf(paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2020/01_Migracion reciente/ChordDiagram de MR5a desagregado por ZM.pdf"), width = 25, height = 25)
...
circos.clear()
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2020/01_Migracion reciente/ChordDiagram de MR5a de ZMVM.pdf"), width = 18, height = 15)
circos.par(start.degree = 90, 
           gap.degree = 3, 
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2020/01_Migracion reciente/ChordDiagram de MR5a de ZMVM_grupos.pdf"), width = 18, height = 15)
circos.clear()
circos.par(start.degree = 90, 
           gap.degree = 3, 
...
```{r, eval = FALSE, results='hide'}
pdf(paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2020/01_Migracion reciente/ChordDiagram de MR5a desagregado por ZM  (Intramunicipal).pdf"), width = 25, height = 22)
for(i in 1:length(ZM_CF)){
circos.clear()  
...
circos.clear()
pdf(paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2020/01_Migracion reciente/ChordDiagram de MR5a de ZMVM (Intramunicipal).pdf"), width = 18, height = 15)
circos.par(start.degree = 90, 
           gap.degree = 3, 
           track.margin = c(-0.1, 0.1), 
           points.overflow.warning = FALSE)
...
circos.clear()
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2020/01_Migracion reciente/ChordDiagram de MR5a de ZMVM_grupos (Intramunicipal).pdf"), width = 22, height = 20)
circos.par(start.degree = 90, 
           gap.degree = 3, 
           track.margin = c(-0.2, 0.2), 
           points.overflow.warning = FALSE)
...
```{r, eval = FALSE, results='hide'}
pdf(paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2020/01_Migracion reciente/ChordDiagram de MR5a desagregado por ZM (Intermunicipal).pdf"), width = 25, height = 25)
for(i in 1:length(ZM_CF)){
...
```{r}
circos.clear()
pdf(paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2020/01_Migracion reciente/ChordDiagram de MR5a de ZMVM (Intermunicipal).pdf"), width = 18, height = 15)
circos.clear()
circos.par(start.degree = 90, 
           gap.degree = 3, 
           track.margin = c(-0.1, 0.1), 
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2020/01_Migracion reciente/ChordDiagram de MR5a de ZMVM_grupos (Intermunicipal).pdf"), width = 22, height = 20)
circos.clear()
circos.par(start.degree = 90, 
           gap.degree = 3, 
           track.margin = c(-0.2, 0.2), 
...
```{r, eval = FALSE, results='hide'}
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2020/01_Migracion reciente/ChordDiagram de MR5a desagregado por ZM (metropolitano).pdf"), width = 25, height = 27)
for(i in 1){
circos.clear()
circos.par(start.degree = 90, 
           gap.degree = 3, 
...
```{r, eval = FALSE, results='hide'}
pdf(paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2020/01_Migracion reciente/ChordDiagram de MR5a desagregado por ZM (metropolitano)_individual.pdf"), width = 27, height = 25)
for(i in 1:length(ZM)){
circos.clear()
circos.par(start.degree = 90, 
           gap.degree = 3, 
