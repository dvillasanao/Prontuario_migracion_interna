...
saveWorkbook(wb, file = paste0(here::here(),  "/Output/Municipio/06_Zonas Metropolitanas/2020/03_Movilidad laboral/SDEM/Indicadores sociodemograficos a nivel metropolitano 2020.xlsx"), overwrite = TRUE)
```
...
saveWorkbook(wb, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2020/03_Movilidad laboral/SDEM/Indicadores sociodemograficos a nivel metropolitano 2020_Porcentajes.xlsx"), overwrite = TRUE)
```
...
writeData(wb, 16, Indicadores("MED_TRASLADO_TRAB2"), colNames = TRUE)
writeData(wb, 17, Indicadores("MED_TRASLADO_TRAB3"), colNames = TRUE)
saveWorkbook(wb, file = paste0(here::here(),  "/Output/Municipio/06_Zonas Metropolitanas/2020/03_Movilidad laboral/SDEM/Indicadores sociodemograficos a nivel intrametropolitano 2020.xlsx"), overwrite = TRUE)
```
...
writeData(wb, 16, Indicadores_P("MED_TRASLADO_TRAB2"), colNames = TRUE)
writeData(wb, 17, Indicadores_P("MED_TRASLADO_TRAB3"), colNames = TRUE)
saveWorkbook(wb, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2020/03_Movilidad laboral/SDEM/Indicadores sociodemograficos a nivel intrametropolitano 2020_Porcentajes.xlsx"), overwrite = TRUE)
```
...
writeData(wb, 16, Indicadores("MED_TRASLADO_TRAB2"), colNames = TRUE)
writeData(wb, 17, Indicadores("MED_TRASLADO_TRAB3"), colNames = TRUE)
saveWorkbook(wb, file = paste0(here::here(),  "/Output/Municipio/06_Zonas Metropolitanas/2020/03_Movilidad laboral/SDEM/Indicadores sociodemograficos a nivel intermetropolitano 2020.xlsx"), overwrite = TRUE)
```
...
writeData(wb, 16, Indicadores_P("MED_TRASLADO_TRAB2"), colNames = TRUE)
writeData(wb, 17, Indicadores_P("MED_TRASLADO_TRAB3"), colNames = TRUE)
saveWorkbook(wb, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2020/03_Movilidad laboral/SDEM/Indicadores sociodemograficos a nivel intermetropolitano 2020_Porcentajes.xlsx"), overwrite = TRUE)
```
