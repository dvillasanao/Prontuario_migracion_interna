...
addWorksheet(wb, "MED_TRASLADO_TRAB2")
addWorksheet(wb, "MED_TRASLADO_TRAB3")
writeData(wb, 1, Indicadores("SEXO", df.claves = CVE_ZM, grupo = zm, Origen = "CVE_ZM", Destino = "CVE_MUN_TRABAJO", filtro = "(EDAD >= 12 & EDAD <= 130) & (CONACT >= 10 & CONACT <= 20)"), colNames = TRUE)
