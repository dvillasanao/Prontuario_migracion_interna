...
paleta <- c("#000C7D", "#001599", "#0022B0", "#0035BB", "#004AB4", "#005EA3", "#00708D", "#078472","#3E9A85", "#49A980", "#58B877", "#70C669", "#9ADC0E",  "#B0D00F", "#C2B72A",  "#D49E46", "#E58560", "#F86C7C", "#F25880", "#E7467F", "#DC327D", "#D1207C", "#C70E7B","#CA0081", "#AD0088","#8E0390", "#780896","#560D9E")
...
#svglite::svglite(paste0(here::here(), "/Graficos/Estado/04_Movilidad estudiantil/2015/ChordDiagram de MEst a nivel estatal.svg"), width = 20, height = 20)
cairo_pdf(paste0(here::here(), "/Graficos/Estado/04_Movilidad estudiantil/2015/ChordDiagram de MEst a nivel estatal.pdf"),
          width = 7, height = 7, 
...
cairo_pdf(paste0(here::here(), "/Graficos/Estado/04_Movilidad estudiantil/2015/ChordDiagram de MEst para cada estado.pdf"),
          width = 8,
          height = 8, 
          family = "Montserrat Medium",
          fallback_resolution = 400,
...
cairo_pdf(paste0(here::here(), "/Graficos/Estado/04_Movilidad estudiantil/2015/Etiquetas a nivel estatal.pdf"), 
          width = 7, height = 8, 
          fallback_resolution = 400,
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/04_Movilidad estudiantil/2015/ChordDiagram de MEst desagregado por estado.pdf"),
          width = 15,
          height = 10, 
          family = "Montserrat Medium",
          fallback_resolution = 400,
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/04_Movilidad estudiantil/2015/Etiquetas a nivel municipal.pdf"), 
          width = 7, height = 10, 
          fallback_resolution = 400,
          family = "montserrat", onefile = TRUE)
for(i in 1:length(estados)){
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/04_Movilidad estudiantil/2015/ChordDiagram de MEst desagregado a nivel intramunicipal.pdf"),
          width = 15,
          height = 10, 
          family = "Montserrat Medium",
          fallback_resolution = 400,
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/04_Movilidad estudiantil/2015/Etiquetas a nivel intramunicipal.pdf"), 
          width = 7, height = 8, 
          fallback_resolution = 400,
          family = "montserrat", onefile = TRUE)
for(i in 1:length(estados)){
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/04_Movilidad estudiantil/2015/ChordDiagram de MEst desagregado a nivel intermunicipal.pdf"),
          width = 15,
          height = 10, 
          family = "Montserrat Medium",
          fallback_resolution = 400,
...
cairo_pdf(paste0(here::here(), "/Graficos/Municipio/04_Movilidad estudiantil/2015/Etiquetas a nivel intermunicipal.pdf"), 
          width = 7, height = 8, 
          fallback_resolution = 400,
          family = "montserrat", onefile = TRUE)
for(i in 1:length(estados)){
